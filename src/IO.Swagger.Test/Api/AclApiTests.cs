...
namespace IO.Swagger.Test
{
    ...
    public class AclApiTests
    {
        ...
        {
            // TODO uncomment below to test 'IsInstanceOfType' AclApi
            //Assert.IsInstanceOfType(typeof(AclApi), instance, "instance is a AclApi");
        }
        ...
        public void DeletePermissionTest()
        {
            ...
            //var response = instance.DeletePermission(docId, permissionId);
            //Assert.IsInstanceOf<DeletePermissionResult> (response, "response is DeletePermissionResult");
        }
        /// <summary>
        /// Test GetAclMetadata
        /// </summary>
        [Test]
        public void GetAclMetadataTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string docId = null;
            //var response = instance.GetAclMetadata(docId);
            //Assert.IsInstanceOf<AclMetadata> (response, "response is AclMetadata");
        }
        /// <summary>
        /// Test GetAclPermissions
        /// </summary>
        [Test]
        public void GetAclPermissionsTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string docId = null;
            //int? limit = null;
            //string pageToken = null;
            //var response = instance.GetAclPermissions(docId, limit, pageToken);
            //Assert.IsInstanceOf<Acl> (response, "response is Acl");
        }
        /// <summary>
        /// Test ShareDoc
        /// </summary>
        [Test]
        public void ShareDocTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //AddPermission body = null;
            //string docId = null;
            //var response = instance.ShareDoc(body, docId);
            //Assert.IsInstanceOf<AddPermissionResult> (response, "response is AddPermissionResult");
        }
    }
