...
namespace IO.Swagger.Test
{
    ...
    public class ColumnsApiTests
    {
        ...
        /// <summary>
        /// Test an instance of ColumnsApi
        /// </summary>
        [Test]
        public void InstanceTest()
        {
            // TODO uncomment below to test 'IsInstanceOfType' ColumnsApi
            //Assert.IsInstanceOfType(typeof(ColumnsApi), instance, "instance is a ColumnsApi");
        }
        ...
        public void GetColumnTest()
        {
            ...
            //var response = instance.GetColumn(docId, tableIdOrName, columnIdOrName);
            //Assert.IsInstanceOf<ColumnDetail> (response, "response is ColumnDetail");
        }
        /// <summary>
        /// Test ListColumns
        /// </summary>
        ...
        public void ListColumnsTest()
        {
            ...
            //var response = instance.ListColumns(docId, tableIdOrName, limit, pageToken, visibleOnly);
            //Assert.IsInstanceOf<ColumnList> (response, "response is ColumnList");
        }
    }
