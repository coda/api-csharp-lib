...
namespace IO.Swagger.Test
{
    ...
    /// </remarks>
    [TestFixture]
    public class ControlsApiTests
    {
        private ControlsApi instance;
        ...
        /// <summary>
        /// Test an instance of ControlsApi
        /// </summary>
        [Test]
        public void InstanceTest()
        {
            // TODO uncomment below to test 'IsInstanceOfType' ControlsApi
            //Assert.IsInstanceOfType(typeof(ControlsApi), instance, "instance is a ControlsApi");
        }
        ...
        public void GetControlTest()
        {
            ...
            //string docId = null;
            //string controlIdOrName = null;
            //var response = instance.GetControl(docId, controlIdOrName);
            //Assert.IsInstanceOf<Control> (response, "response is Control");
        }
        /// <summary>
        /// Test ListControls
        /// </summary>
        [Test]
        public void ListControlsTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string docId = null;
            //int? limit = null;
            ...
            //SortBy sortBy = null;
            //var response = instance.ListControls(docId, limit, pageToken, sortBy);
            //Assert.IsInstanceOf<ControlList> (response, "response is ControlList");
        }
    }
