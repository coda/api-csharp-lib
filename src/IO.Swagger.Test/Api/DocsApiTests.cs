...
namespace IO.Swagger.Test
{
    ...
    public class DocsApiTests
    {
        ...
        public void CreateDocTest()
        {
            ...
            //DocCreate body = null;
            //var response = instance.CreateDoc(body);
            //Assert.IsInstanceOf<Doc> (response, "response is Doc");
        }
        /// <summary>
        /// Test DeleteDoc
        /// </summary>
        ...
        public void DeleteDocTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string docId = null;
            //var response = instance.DeleteDoc(docId);
            //Assert.IsInstanceOf<DocDelete> (response, "response is DocDelete");
        }
        /// <summary>
        /// Test GetDoc
        /// </summary>
        ...
        public void GetDocTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string docId = null;
            //var response = instance.GetDoc(docId);
            //Assert.IsInstanceOf<Doc> (response, "response is Doc");
        }
        /// <summary>
        /// Test ListDocs
        ...
        public void ListDocsTest()
        {
            ...
            //var response = instance.ListDocs(isOwner, query, sourceDoc, isStarred, inGallery, workspaceId, folderId, limit, pageToken);
            //Assert.IsInstanceOf<DocList> (response, "response is DocList");
        }
    }
