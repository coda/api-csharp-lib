...
namespace IO.Swagger.Test
{
    ...
    /// </remarks>
    [TestFixture]
    public class FormulasApiTests
    {
        private FormulasApi instance;
        ...
        /// <summary>
        /// Test an instance of FormulasApi
        /// </summary>
        [Test]
        public void InstanceTest()
        {
            // TODO uncomment below to test 'IsInstanceOfType' FormulasApi
            //Assert.IsInstanceOfType(typeof(FormulasApi), instance, "instance is a FormulasApi");
        }
        ...
        public void GetFormulaTest()
        {
            ...
            //string docId = null;
            //string formulaIdOrName = null;
            //var response = instance.GetFormula(docId, formulaIdOrName);
            //Assert.IsInstanceOf<Formula> (response, "response is Formula");
        }
        /// <summary>
        /// Test ListFormulas
        /// </summary>
        [Test]
        public void ListFormulasTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string docId = null;
            //int? limit = null;
            ...
            //SortBy sortBy = null;
            //var response = instance.ListFormulas(docId, limit, pageToken, sortBy);
            //Assert.IsInstanceOf<FormulaList> (response, "response is FormulaList");
        }
    }
