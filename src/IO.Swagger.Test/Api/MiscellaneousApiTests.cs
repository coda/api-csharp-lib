...
namespace IO.Swagger.Test
{
    ...
    public class MiscellaneousApiTests
    {
        ...
        /// <summary>
        /// Test GetMutationStatus
        /// </summary>
        [Test]
        public void GetMutationStatusTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string requestId = null;
            //var response = instance.GetMutationStatus(requestId);
            //Assert.IsInstanceOf<MutationStatus> (response, "response is MutationStatus");
        }
        /// <summary>
        /// Test ResolveBrowserLink
        /// </summary>
        [Test]
        public void ResolveBrowserLinkTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string url = null;
            //bool? degradeGracefully = null;
            //var response = instance.ResolveBrowserLink(url, degradeGracefully);
            //Assert.IsInstanceOf<ApiLink> (response, "response is ApiLink");
        }
    }
