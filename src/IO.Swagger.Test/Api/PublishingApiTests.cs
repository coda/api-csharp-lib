...
{
    /// <summary>
    ///  Class for testing PublishingApi
    /// </summary>
    /// <remarks>
    ...
    /// </remarks>
    [TestFixture]
    public class PublishingApiTests
    {
        private PublishingApi instance;
        ...
        /// <summary>
        /// Test an instance of PublishingApi
        /// </summary>
        [Test]
        public void InstanceTest()
        {
            // TODO uncomment below to test 'IsInstanceOfType' PublishingApi
            //Assert.IsInstanceOfType(typeof(PublishingApi), instance, "instance is a PublishingApi");
        }
        ...
        public void ListCategoriesTest()
        {
            ...
            //Assert.IsInstanceOf<DocCategoryList> (response, "response is DocCategoryList");
        }
        /// <summary>
        /// Test PublishDoc
        /// </summary>
        [Test]
        public void PublishDocTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //DocPublish body = null;
            //string docId = null;
            //var response = instance.PublishDoc(body, docId);
            //Assert.IsInstanceOf<PublishResult> (response, "response is PublishResult");
        }
        /// <summary>
        /// Test UnpublishDoc
        /// </summary>
        [Test]
        public void UnpublishDocTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string docId = null;
            //var response = instance.UnpublishDoc(docId);
            //Assert.IsInstanceOf<UnpublishResult> (response, "response is UnpublishResult");
        }
    }
