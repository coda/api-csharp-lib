...
namespace IO.Swagger.Test
{
    ...
    public class RowsApiTests
    {
        ...
        {
            // TODO uncomment below to test 'IsInstanceOfType' RowsApi
            //Assert.IsInstanceOfType(typeof(RowsApi), instance, "instance is a RowsApi");
        }
        ...
        public void DeleteRowTest()
        {
            ...
            //string rowIdOrName = null;
            //var response = instance.DeleteRow(docId, tableIdOrName, rowIdOrName);
            //Assert.IsInstanceOf<RowDeleteResult> (response, "response is RowDeleteResult");
        }
        /// <summary>
        /// Test DeleteRows
        /// </summary>
        ...
        {
            // TODO uncomment below to test the method and replace null with proper value
            //RowsDelete body = null;
            //string docId = null;
            //string tableIdOrName = null;
            //var response = instance.DeleteRows(body, docId, tableIdOrName);
            //Assert.IsInstanceOf<RowsDeleteResult> (response, "response is RowsDeleteResult");
        }
        /// <summary>
        /// Test GetRow
        /// </summary>
        ...
        public void GetRowTest()
        {
            ...
            //string tableIdOrName = null;
            //string rowIdOrName = null;
            //bool? useColumnNames = null;
            //ValueFormat valueFormat = null;
            //var response = instance.GetRow(docId, tableIdOrName, rowIdOrName, useColumnNames, valueFormat);
            //Assert.IsInstanceOf<RowDetail> (response, "response is RowDetail");
        }
        /// <summary>
        /// Test ListRows
        /// </summary>
        ...
        public void ListRowsTest()
        {
            ...
            //string tableIdOrName = null;
            //string query = null;
            //RowsSortBy sortBy = null;
            //bool? useColumnNames = null;
            //ValueFormat valueFormat = null;
            //bool? visibleOnly = null;
            //int? limit = null;
            //string pageToken = null;
            //var response = instance.ListRows(docId, tableIdOrName, query, sortBy, useColumnNames, valueFormat, visibleOnly, limit, pageToken);
            //Assert.IsInstanceOf<RowList> (response, "response is RowList");
        }
        /// <summary>
        /// Test PushButton
        /// </summary>
        ...
        public void PushButtonTest()
        {
            ...
            //string tableIdOrName = null;
            //string rowIdOrName = null;
            //string columnIdOrName = null;
            //var response = instance.PushButton(docId, tableIdOrName, rowIdOrName, columnIdOrName);
            //Assert.IsInstanceOf<PushButtonResult> (response, "response is PushButtonResult");
        }
        /// <summary>
        /// Test UpdateRow
        /// </summary>
        ...
        public void UpdateRowTest()
        {
            ...
            //string tableIdOrName = null;
            //string rowIdOrName = null;
            //bool? disableParsing = null;
            //var response = instance.UpdateRow(body, docId, tableIdOrName, rowIdOrName, disableParsing);
            //Assert.IsInstanceOf<RowUpdateResult> (response, "response is RowUpdateResult");
        }
        /// <summary>
        /// Test UpsertRows
        /// </summary>
        [Test]
        public void UpsertRowsTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //RowsUpsert body = null;
            //string docId = null;
            //string tableIdOrName = null;
            //bool? disableParsing = null;
            //var response = instance.UpsertRows(body, docId, tableIdOrName, disableParsing);
            //Assert.IsInstanceOf<RowsUpsertResult> (response, "response is RowsUpsertResult");
        }
    }
