...
namespace IO.Swagger.Test
{
    ...
    public class TablesApiTests
    {
        ...
        public void GetTableTest()
        {
            ...
            //var response = instance.GetTable(docId, tableIdOrName);
            //Assert.IsInstanceOf<Table> (response, "response is Table");
        }
        /// <summary>
        /// Test ListTables
        /// </summary>
        ...
        public void ListTablesTest()
        {
            ...
            //var response = instance.ListTables(docId, limit, pageToken, sortBy, tableTypes);
            //Assert.IsInstanceOf<TableList> (response, "response is TableList");
        }
    }
