...
namespace IO.Swagger.Api
{
        ...
        public interface IAccountApi : IApiAccessor
    {
        ...
        ApiResponse<User> WhoamiWithHttpInfo ();
        ...
        System.Threading.Tasks.Task<User> WhoamiAsync ();
        ...
        System.Threading.Tasks.Task<ApiResponse<User>> WhoamiAsyncWithHttpInfo ();
        ...
        public partial class AccountApi : IAccountApi
    {
        ...
        public User Whoami ()
        {
             ApiResponse<User> localVarResponse = WhoamiWithHttpInfo();
        ...
        /// <exception cref="IO.Swagger.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>ApiResponse of User</returns>
        public ApiResponse< User > WhoamiWithHttpInfo ()
        {

            var localVarPath = "/whoami";
            ...
            {
                Exception exception = ExceptionFactory("Whoami", localVarResponse);
        ...
        /// <exception cref="IO.Swagger.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>Task of User</returns>
        public async System.Threading.Tasks.Task<User> WhoamiAsync ()
        {
             ApiResponse<User> localVarResponse = await WhoamiAsyncWithHttpInfo();
             return localVarResponse.Data;
        ...
        /// <exception cref="IO.Swagger.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>Task of ApiResponse (User)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<User>> WhoamiAsyncWithHttpInfo ()
        {
