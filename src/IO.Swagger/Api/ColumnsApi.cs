...
namespace IO.Swagger.Api
{
    ...
    /// </summary>
        public interface IColumnsApi : IApiAccessor
    {
        ...
        /// <param name="tableIdOrName">ID or name of the table. Names are discouraged because they&#x27;re easily prone to being changed by users. If you&#x27;re using a name, be sure to URI-encode it.</param>
        /// <param name="columnIdOrName">ID or name of the column. Names are discouraged because they&#x27;re easily prone to being changed by users. If you&#x27;re using a name, be sure to URI-encode it.</param>
        /// <returns>ApiResponse of ColumnDetail</returns>
        ApiResponse<ColumnDetail> GetColumnWithHttpInfo (string docId, string tableIdOrName, string columnIdOrName);
        /// <summary>
        /// List columns
        /// </summary>
        /// <remarks>
        ...
        /// <param name="visibleOnly">If true, returns only visible columns for the table. (optional)</param>
        ...
        /// <param name="pageToken">An opaque token used to fetch the next page of results. (optional)</param>
        /// <param name="visibleOnly">If true, returns only visible columns for the table. (optional)</param>
        /// <returns>ApiResponse of ColumnList</returns>
        ApiResponse<ColumnList> ListColumnsWithHttpInfo (string docId, string tableIdOrName, int? limit = null, string pageToken = null, bool? visibleOnly = null);
        ...
        /// <param name="tableIdOrName">ID or name of the table. Names are discouraged because they&#x27;re easily prone to being changed by users. If you&#x27;re using a name, be sure to URI-encode it.</param>
        /// <param name="columnIdOrName">ID or name of the column. Names are discouraged because they&#x27;re easily prone to being changed by users. If you&#x27;re using a name, be sure to URI-encode it.</param>
        /// <returns>Task of ColumnDetail</returns>
        System.Threading.Tasks.Task<ColumnDetail> GetColumnAsync (string docId, string tableIdOrName, string columnIdOrName);
        ...
        /// <param name="tableIdOrName">ID or name of the table. Names are discouraged because they&#x27;re easily prone to being changed by users. If you&#x27;re using a name, be sure to URI-encode it.</param>
        /// <param name="columnIdOrName">ID or name of the column. Names are discouraged because they&#x27;re easily prone to being changed by users. If you&#x27;re using a name, be sure to URI-encode it.</param>
        /// <returns>Task of ApiResponse (ColumnDetail)</returns>
        System.Threading.Tasks.Task<ApiResponse<ColumnDetail>> GetColumnAsyncWithHttpInfo (string docId, string tableIdOrName, string columnIdOrName);
        /// <summary>
        /// List columns
        /// </summary>
        /// <remarks>
        ...
        /// <param name="pageToken">An opaque token used to fetch the next page of results. (optional)</param>
        /// <param name="visibleOnly">If true, returns only visible columns for the table. (optional)</param>
        /// <returns>Task of ColumnList</returns>
        System.Threading.Tasks.Task<ColumnList> ListColumnsAsync (string docId, string tableIdOrName, int? limit = null, string pageToken = null, bool? visibleOnly = null);
        ...
        /// <param name="pageToken">An opaque token used to fetch the next page of results. (optional)</param>
        /// <param name="visibleOnly">If true, returns only visible columns for the table. (optional)</param>
        /// <returns>Task of ApiResponse (ColumnList)</returns>
        System.Threading.Tasks.Task<ApiResponse<ColumnList>> ListColumnsAsyncWithHttpInfo (string docId, string tableIdOrName, int? limit = null, string pageToken = null, bool? visibleOnly = null);
        ...
        public partial class ColumnsApi : IColumnsApi
    {
        ...
        /// <returns></returns>
        public ColumnsApi(IO.Swagger.Client.Configuration configuration = null)
        {
        ...
        /// <param name="columnIdOrName">ID or name of the column. Names are discouraged because they&#x27;re easily prone to being changed by users. If you&#x27;re using a name, be sure to URI-encode it.</param>
        /// <returns>ColumnDetail</returns>
        public ColumnDetail GetColumn (string docId, string tableIdOrName, string columnIdOrName)
        {
             ApiResponse<ColumnDetail> localVarResponse = GetColumnWithHttpInfo(docId, tableIdOrName, columnIdOrName);
        ...
        /// <param name="columnIdOrName">ID or name of the column. Names are discouraged because they&#x27;re easily prone to being changed by users. If you&#x27;re using a name, be sure to URI-encode it.</param>
        /// <returns>ApiResponse of ColumnDetail</returns>
        public ApiResponse< ColumnDetail > GetColumnWithHttpInfo (string docId, string tableIdOrName, string columnIdOrName)
        {
            // verify the required parameter 'docId' is set
            if (docId == null)
                throw new ApiException(400, "Missing required parameter 'docId' when calling ColumnsApi->GetColumn");
            // verify the required parameter 'tableIdOrName' is set
            if (tableIdOrName == null)
                throw new ApiException(400, "Missing required parameter 'tableIdOrName' when calling ColumnsApi->GetColumn");
            // verify the required parameter 'columnIdOrName' is set
            if (columnIdOrName == null)
                throw new ApiException(400, "Missing required parameter 'columnIdOrName' when calling ColumnsApi->GetColumn");

            var localVarPath = "/docs/{docId}/tables/{tableIdOrName}/columns/{columnIdOrName}";
            ...
            {
                Exception exception = ExceptionFactory("GetColumn", localVarResponse);
                if (exception != null) throw exception;
            }

            return new ApiResponse<ColumnDetail>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => string.Join(",", x.Value)),
                (ColumnDetail) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(ColumnDetail)));
        }
        ...
        /// <param name="columnIdOrName">ID or name of the column. Names are discouraged because they&#x27;re easily prone to being changed by users. If you&#x27;re using a name, be sure to URI-encode it.</param>
        /// <returns>Task of ColumnDetail</returns>
        public async System.Threading.Tasks.Task<ColumnDetail> GetColumnAsync (string docId, string tableIdOrName, string columnIdOrName)
        {
             ApiResponse<ColumnDetail> localVarResponse = await GetColumnAsyncWithHttpInfo(docId, tableIdOrName, columnIdOrName);
             return localVarResponse.Data;
        ...
        /// <param name="columnIdOrName">ID or name of the column. Names are discouraged because they&#x27;re easily prone to being changed by users. If you&#x27;re using a name, be sure to URI-encode it.</param>
        /// <returns>Task of ApiResponse (ColumnDetail)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<ColumnDetail>> GetColumnAsyncWithHttpInfo (string docId, string tableIdOrName, string columnIdOrName)
        {
            // verify the required parameter 'docId' is set
            if (docId == null)
                throw new ApiException(400, "Missing required parameter 'docId' when calling ColumnsApi->GetColumn");
        ...
        /// <param name="visibleOnly">If true, returns only visible columns for the table. (optional)</param>
        /// <returns>ColumnList</returns>
        public ColumnList ListColumns (string docId, string tableIdOrName, int? limit = null, string pageToken = null, bool? visibleOnly = null)
        {
             ApiResponse<ColumnList> localVarResponse = ListColumnsWithHttpInfo(docId, tableIdOrName, limit, pageToken, visibleOnly);
             return localVarResponse.Data;
        }
        ...
        /// <param name="visibleOnly">If true, returns only visible columns for the table. (optional)</param>
        /// <returns>ApiResponse of ColumnList</returns>
        public ApiResponse< ColumnList > ListColumnsWithHttpInfo (string docId, string tableIdOrName, int? limit = null, string pageToken = null, bool? visibleOnly = null)
        {
            // verify the required parameter 'docId' is set
            if (docId == null)
                throw new ApiException(400, "Missing required parameter 'docId' when calling ColumnsApi->ListColumns");
            // verify the required parameter 'tableIdOrName' is set
            if (tableIdOrName == null)
                throw new ApiException(400, "Missing required parameter 'tableIdOrName' when calling ColumnsApi->ListColumns");

            var localVarPath = "/docs/{docId}/tables/{tableIdOrName}/columns";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new List<KeyValuePair<String, String>>();
            var localVarHeaderParams = new Dictionary<String, String>(this.Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("ListColumns", localVarResponse);
                if (exception != null) throw exception;
            }

            return new ApiResponse<ColumnList>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => string.Join(",", x.Value)),
                (ColumnList) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(ColumnList)));
        }
        ...
        /// <param name="visibleOnly">If true, returns only visible columns for the table. (optional)</param>
        /// <returns>Task of ColumnList</returns>
        public async System.Threading.Tasks.Task<ColumnList> ListColumnsAsync (string docId, string tableIdOrName, int? limit = null, string pageToken = null, bool? visibleOnly = null)
        {
             ApiResponse<ColumnList> localVarResponse = await ListColumnsAsyncWithHttpInfo(docId, tableIdOrName, limit, pageToken, visibleOnly);
             return localVarResponse.Data;
        ...
        /// <param name="visibleOnly">If true, returns only visible columns for the table. (optional)</param>
        /// <returns>Task of ApiResponse (ColumnList)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<ColumnList>> ListColumnsAsyncWithHttpInfo (string docId, string tableIdOrName, int? limit = null, string pageToken = null, bool? visibleOnly = null)
        {
            // verify the required parameter 'docId' is set
            if (docId == null)
                throw new ApiException(400, "Missing required parameter 'docId' when calling ColumnsApi->ListColumns");
