...
namespace IO.Swagger.Api
{
    ...
    /// </summary>
        public interface IControlsApi : IApiAccessor
    {
        ...
        /// <param name="controlIdOrName">ID or name of the control. Names are discouraged because they&#x27;re easily prone to being changed by users. If you&#x27;re using a name, be sure to URI-encode it.</param>
        ...
        /// <param name="docId">ID of the doc.</param>
        /// <param name="controlIdOrName">ID or name of the control. Names are discouraged because they&#x27;re easily prone to being changed by users. If you&#x27;re using a name, be sure to URI-encode it.</param>
        /// <returns>ApiResponse of Control</returns>
        ApiResponse<Control> GetControlWithHttpInfo (string docId, string controlIdOrName);
        /// <summary>
        /// List controls
        /// </summary>
        /// <remarks>
        ...
        /// <param name="pageToken">An opaque token used to fetch the next page of results. (optional)</param>
        /// <param name="sortBy">Determines how to sort the given objects. (optional)</param>
        /// <returns>ApiResponse of ControlList</returns>
        ApiResponse<ControlList> ListControlsWithHttpInfo (string docId, int? limit = null, string pageToken = null, SortBy sortBy = null);
        ...
        /// <param name="docId">ID of the doc.</param>
        /// <param name="controlIdOrName">ID or name of the control. Names are discouraged because they&#x27;re easily prone to being changed by users. If you&#x27;re using a name, be sure to URI-encode it.</param>
        /// <returns>Task of Control</returns>
        System.Threading.Tasks.Task<Control> GetControlAsync (string docId, string controlIdOrName);
        ...
        /// <param name="docId">ID of the doc.</param>
        /// <param name="controlIdOrName">ID or name of the control. Names are discouraged because they&#x27;re easily prone to being changed by users. If you&#x27;re using a name, be sure to URI-encode it.</param>
        /// <returns>Task of ApiResponse (Control)</returns>
        System.Threading.Tasks.Task<ApiResponse<Control>> GetControlAsyncWithHttpInfo (string docId, string controlIdOrName);
        /// <summary>
        /// List controls
        /// </summary>
        /// <remarks>
        ...
        /// <param name="pageToken">An opaque token used to fetch the next page of results. (optional)</param>
        /// <param name="sortBy">Determines how to sort the given objects. (optional)</param>
        /// <returns>Task of ControlList</returns>
        System.Threading.Tasks.Task<ControlList> ListControlsAsync (string docId, int? limit = null, string pageToken = null, SortBy sortBy = null);
        ...
        /// <param name="pageToken">An opaque token used to fetch the next page of results. (optional)</param>
        /// <param name="sortBy">Determines how to sort the given objects. (optional)</param>
        /// <returns>Task of ApiResponse (ControlList)</returns>
        System.Threading.Tasks.Task<ApiResponse<ControlList>> ListControlsAsyncWithHttpInfo (string docId, int? limit = null, string pageToken = null, SortBy sortBy = null);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
        public partial class ControlsApi : IControlsApi
    {
        private IO.Swagger.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="ControlsApi"/> class.
        /// </summary>
        /// <returns></returns>
        public ControlsApi(String basePath)
        {
        ...
        /// <returns></returns>
        public ControlsApi(IO.Swagger.Client.Configuration configuration = null)
        {
        ...
        /// <param name="controlIdOrName">ID or name of the control. Names are discouraged because they&#x27;re easily prone to being changed by users. If you&#x27;re using a name, be sure to URI-encode it.</param>
        /// <returns>Control</returns>
        public Control GetControl (string docId, string controlIdOrName)
        {
             ApiResponse<Control> localVarResponse = GetControlWithHttpInfo(docId, controlIdOrName);
        ...
        /// <param name="controlIdOrName">ID or name of the control. Names are discouraged because they&#x27;re easily prone to being changed by users. If you&#x27;re using a name, be sure to URI-encode it.</param>
        /// <returns>ApiResponse of Control</returns>
        public ApiResponse< Control > GetControlWithHttpInfo (string docId, string controlIdOrName)
        {
            // verify the required parameter 'docId' is set
            if (docId == null)
                throw new ApiException(400, "Missing required parameter 'docId' when calling ControlsApi->GetControl");
            // verify the required parameter 'controlIdOrName' is set
            if (controlIdOrName == null)
                throw new ApiException(400, "Missing required parameter 'controlIdOrName' when calling ControlsApi->GetControl");

            var localVarPath = "/docs/{docId}/controls/{controlIdOrName}";
            ...
            if (controlIdOrName != null) localVarPathParams.Add("controlIdOrName", this.Configuration.ApiClient.ParameterToString(controlIdOrName)); // path parameter
            ...
            return new ApiResponse<Control>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => string.Join(",", x.Value)),
                (Control) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(Control)));
        }
        ...
        /// <param name="controlIdOrName">ID or name of the control. Names are discouraged because they&#x27;re easily prone to being changed by users. If you&#x27;re using a name, be sure to URI-encode it.</param>
        /// <returns>Task of Control</returns>
        public async System.Threading.Tasks.Task<Control> GetControlAsync (string docId, string controlIdOrName)
        {
             ApiResponse<Control> localVarResponse = await GetControlAsyncWithHttpInfo(docId, controlIdOrName);
             return localVarResponse.Data;
        ...
        /// <param name="controlIdOrName">ID or name of the control. Names are discouraged because they&#x27;re easily prone to being changed by users. If you&#x27;re using a name, be sure to URI-encode it.</param>
        /// <returns>Task of ApiResponse (Control)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Control>> GetControlAsyncWithHttpInfo (string docId, string controlIdOrName)
        {
            // verify the required parameter 'docId' is set
            if (docId == null)
                throw new ApiException(400, "Missing required parameter 'docId' when calling ControlsApi->GetControl");
        ...
        /// <param name="sortBy">Determines how to sort the given objects. (optional)</param>
        /// <returns>ControlList</returns>
        public ControlList ListControls (string docId, int? limit = null, string pageToken = null, SortBy sortBy = null)
        {
             ApiResponse<ControlList> localVarResponse = ListControlsWithHttpInfo(docId, limit, pageToken, sortBy);
             return localVarResponse.Data;
        }
        ...
        /// <param name="sortBy">Determines how to sort the given objects. (optional)</param>
        /// <returns>ApiResponse of ControlList</returns>
        public ApiResponse< ControlList > ListControlsWithHttpInfo (string docId, int? limit = null, string pageToken = null, SortBy sortBy = null)
        {
            // verify the required parameter 'docId' is set
            if (docId == null)
                throw new ApiException(400, "Missing required parameter 'docId' when calling ControlsApi->ListControls");

            var localVarPath = "/docs/{docId}/controls";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new List<KeyValuePair<String, String>>();
            var localVarHeaderParams = new Dictionary<String, String>(this.Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("ListControls", localVarResponse);
                if (exception != null) throw exception;
            }

            return new ApiResponse<ControlList>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => string.Join(",", x.Value)),
                (ControlList) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(ControlList)));
        }
        ...
        /// <param name="sortBy">Determines how to sort the given objects. (optional)</param>
        /// <returns>Task of ControlList</returns>
        public async System.Threading.Tasks.Task<ControlList> ListControlsAsync (string docId, int? limit = null, string pageToken = null, SortBy sortBy = null)
        {
             ApiResponse<ControlList> localVarResponse = await ListControlsAsyncWithHttpInfo(docId, limit, pageToken, sortBy);
             return localVarResponse.Data;
        ...
        /// <param name="sortBy">Determines how to sort the given objects. (optional)</param>
        /// <returns>Task of ApiResponse (ControlList)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<ControlList>> ListControlsAsyncWithHttpInfo (string docId, int? limit = null, string pageToken = null, SortBy sortBy = null)
        {
            // verify the required parameter 'docId' is set
            if (docId == null)
                throw new ApiException(400, "Missing required parameter 'docId' when calling ControlsApi->ListControls");
