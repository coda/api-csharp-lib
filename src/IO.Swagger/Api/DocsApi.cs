...
namespace IO.Swagger.Api
{
        ...
        public interface IDocsApi : IApiAccessor
    {
        ...
        /// <param name="body">Parameters for creating the doc.</param>
        /// <returns>Doc</returns>
        ...
        /// <exception cref="IO.Swagger.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="body">Parameters for creating the doc.</param>
        /// <returns>ApiResponse of Doc</returns>
        ApiResponse<Doc> CreateDocWithHttpInfo (DocCreate body);
        /// <summary>
        /// Delete doc
        /// </summary>
        /// <remarks>
        ...
        /// <exception cref="IO.Swagger.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="docId">ID of the doc.</param>
        /// <returns>ApiResponse of DocDelete</returns>
        ApiResponse<DocDelete> DeleteDocWithHttpInfo (string docId);
        /// <summary>
        ...
        /// <param name="docId">ID of the doc.</param>
        /// <returns>ApiResponse of Doc</returns>
        ApiResponse<Doc> GetDocWithHttpInfo (string docId);
        /// <summary>
        /// List available docs
        /// </summary>
        /// <remarks>
        ...
        /// </remarks>
        /// <exception cref="IO.Swagger.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="isOwner">Show only docs owned by the user. (optional)</param>
        /// <param name="query">Search term used to filter down results. (optional)</param>
        /// <param name="sourceDoc">Show only docs copied from the specified doc ID. (optional)</param>
        /// <param name="isStarred">If true, returns docs that are starred. If false, returns docs that are not starred. (optional)</param>
        /// <param name="inGallery">Show only docs visible within the gallery. (optional)</param>
        /// <param name="workspaceId">Show only docs belonging to the given workspace. (optional)</param>
        /// <param name="folderId">Show only docs belonging to the given folder. (optional)</param>
        ...
        /// <param name="limit">Maximum number of results to return in this query. (optional)</param>
        /// <param name="pageToken">An opaque token used to fetch the next page of results. (optional)</param>
        /// <returns>ApiResponse of DocList</returns>
        ApiResponse<DocList> ListDocsWithHttpInfo (bool? isOwner = null, string query = null, string sourceDoc = null, bool? isStarred = null, bool? inGallery = null, string workspaceId = null, string folderId = null, int? limit = null, string pageToken = null);
        ...
        /// <exception cref="IO.Swagger.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="body">Parameters for creating the doc.</param>
        /// <returns>Task of Doc</returns>
        System.Threading.Tasks.Task<Doc> CreateDocAsync (DocCreate body);
        ...
        /// <exception cref="IO.Swagger.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="body">Parameters for creating the doc.</param>
        /// <returns>Task of ApiResponse (Doc)</returns>
        System.Threading.Tasks.Task<ApiResponse<Doc>> CreateDocAsyncWithHttpInfo (DocCreate body);
        /// <summary>
        /// Delete doc
        /// </summary>
        /// <remarks>
        ...
        /// <exception cref="IO.Swagger.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="docId">ID of the doc.</param>
        /// <returns>Task of DocDelete</returns>
        System.Threading.Tasks.Task<DocDelete> DeleteDocAsync (string docId);
        ...
        /// <exception cref="IO.Swagger.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="docId">ID of the doc.</param>
        /// <returns>Task of ApiResponse (DocDelete)</returns>
        System.Threading.Tasks.Task<ApiResponse<DocDelete>> DeleteDocAsyncWithHttpInfo (string docId);
        /// <summary>
        /// Get info about a doc
        /// </summary>
        /// <remarks>
        ...
        /// <param name="docId">ID of the doc.</param>
        /// <returns>Task of Doc</returns>
        System.Threading.Tasks.Task<Doc> GetDocAsync (string docId);
        ...
        /// <param name="docId">ID of the doc.</param>
        /// <returns>Task of ApiResponse (Doc)</returns>
        System.Threading.Tasks.Task<ApiResponse<Doc>> GetDocAsyncWithHttpInfo (string docId);
        /// <summary>
        /// List available docs
        /// </summary>
        /// <remarks>
        ...
        /// <param name="limit">Maximum number of results to return in this query. (optional)</param>
        /// <param name="pageToken">An opaque token used to fetch the next page of results. (optional)</param>
        /// <returns>Task of DocList</returns>
        System.Threading.Tasks.Task<DocList> ListDocsAsync (bool? isOwner = null, string query = null, string sourceDoc = null, bool? isStarred = null, bool? inGallery = null, string workspaceId = null, string folderId = null, int? limit = null, string pageToken = null);
        ...
        /// <param name="limit">Maximum number of results to return in this query. (optional)</param>
        /// <param name="pageToken">An opaque token used to fetch the next page of results. (optional)</param>
        /// <returns>Task of ApiResponse (DocList)</returns>
        System.Threading.Tasks.Task<ApiResponse<DocList>> ListDocsAsyncWithHttpInfo (bool? isOwner = null, string query = null, string sourceDoc = null, bool? isStarred = null, bool? inGallery = null, string workspaceId = null, string folderId = null, int? limit = null, string pageToken = null);
        ...
        public partial class DocsApi : IDocsApi
    {
        ...
        /// <param name="body">Parameters for creating the doc.</param>
        /// <returns>Doc</returns>
        public Doc CreateDoc (DocCreate body)
        {
             ApiResponse<Doc> localVarResponse = CreateDocWithHttpInfo(body);
        ...
        /// <param name="body">Parameters for creating the doc.</param>
        /// <returns>ApiResponse of Doc</returns>
        public ApiResponse< Doc > CreateDocWithHttpInfo (DocCreate body)
        {
            // verify the required parameter 'body' is set
            if (body == null)
                throw new ApiException(400, "Missing required parameter 'body' when calling DocsApi->CreateDoc");
            ...
            return new ApiResponse<Doc>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => string.Join(",", x.Value)),
                (Doc) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(Doc)));
        }
        ...
        /// <param name="body">Parameters for creating the doc.</param>
        /// <returns>Task of Doc</returns>
        public async System.Threading.Tasks.Task<Doc> CreateDocAsync (DocCreate body)
        {
             ApiResponse<Doc> localVarResponse = await CreateDocAsyncWithHttpInfo(body);
             return localVarResponse.Data;
        ...
        /// <param name="body">Parameters for creating the doc.</param>
        /// <returns>Task of ApiResponse (Doc)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Doc>> CreateDocAsyncWithHttpInfo (DocCreate body)
        {
            // verify the required parameter 'body' is set
            if (body == null)
                throw new ApiException(400, "Missing required parameter 'body' when calling DocsApi->CreateDoc");
        ...
        /// <summary>
        /// Delete doc Deletes a doc.
        /// </summary>
        /// <exception cref="IO.Swagger.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="docId">ID of the doc.</param>
        /// <returns>DocDelete</returns>
        public DocDelete DeleteDoc (string docId)
        {
             ApiResponse<DocDelete> localVarResponse = DeleteDocWithHttpInfo(docId);
             return localVarResponse.Data;
        }
        ...
        /// <param name="docId">ID of the doc.</param>
        /// <returns>ApiResponse of DocDelete</returns>
        public ApiResponse< DocDelete > DeleteDocWithHttpInfo (string docId)
        {
            // verify the required parameter 'docId' is set
            if (docId == null)
                throw new ApiException(400, "Missing required parameter 'docId' when calling DocsApi->DeleteDoc");

            var localVarPath = "/docs/{docId}";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new List<KeyValuePair<String, String>>();
            var localVarHeaderParams = new Dictionary<String, String>(this.Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("DeleteDoc", localVarResponse);
                if (exception != null) throw exception;
            }

            return new ApiResponse<DocDelete>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => string.Join(",", x.Value)),
                (DocDelete) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(DocDelete)));
        }
        ...
        /// <param name="docId">ID of the doc.</param>
        /// <returns>Task of DocDelete</returns>
        public async System.Threading.Tasks.Task<DocDelete> DeleteDocAsync (string docId)
        {
             ApiResponse<DocDelete> localVarResponse = await DeleteDocAsyncWithHttpInfo(docId);
             return localVarResponse.Data;
        ...
        /// <param name="docId">ID of the doc.</param>
        /// <returns>Task of ApiResponse (DocDelete)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<DocDelete>> DeleteDocAsyncWithHttpInfo (string docId)
        {
            // verify the required parameter 'docId' is set
            if (docId == null)
                throw new ApiException(400, "Missing required parameter 'docId' when calling DocsApi->DeleteDoc");
        ...
        /// <summary>
        /// Get info about a doc Returns metadata for the specified doc.
        /// </summary>
        /// <exception cref="IO.Swagger.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="docId">ID of the doc.</param>
        /// <returns>Doc</returns>
        ...
        {
             ApiResponse<Doc> localVarResponse = GetDocWithHttpInfo(docId);
             return localVarResponse.Data;
        }
        ...
        /// <param name="docId">ID of the doc.</param>
        /// <returns>ApiResponse of Doc</returns>
        public ApiResponse< Doc > GetDocWithHttpInfo (string docId)
        {
            // verify the required parameter 'docId' is set
            if (docId == null)
                throw new ApiException(400, "Missing required parameter 'docId' when calling DocsApi->GetDoc");
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("GetDoc", localVarResponse);
                if (exception != null) throw exception;
            }
        ...
        /// <param name="docId">ID of the doc.</param>
        /// <returns>Task of Doc</returns>
        public async System.Threading.Tasks.Task<Doc> GetDocAsync (string docId)
        {
             ApiResponse<Doc> localVarResponse = await GetDocAsyncWithHttpInfo(docId);
             return localVarResponse.Data;
        ...
        /// <param name="docId">ID of the doc.</param>
        /// <returns>Task of ApiResponse (Doc)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Doc>> GetDocAsyncWithHttpInfo (string docId)
        {
            // verify the required parameter 'docId' is set
            if (docId == null)
                throw new ApiException(400, "Missing required parameter 'docId' when calling DocsApi->GetDoc");
        ...
        /// <summary>
        /// List available docs Returns a list of Coda docs accessible by the user. These are returned in the same order as on the docs page: reverse chronological by the latest event relevant to the user (last viewed, edited, or shared). 
        /// </summary>
        /// <exception cref="IO.Swagger.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="isOwner">Show only docs owned by the user. (optional)</param>
        /// <param name="query">Search term used to filter down results. (optional)</param>
        ...
        /// <param name="pageToken">An opaque token used to fetch the next page of results. (optional)</param>
        /// <returns>DocList</returns>
        public DocList ListDocs (bool? isOwner = null, string query = null, string sourceDoc = null, bool? isStarred = null, bool? inGallery = null, string workspaceId = null, string folderId = null, int? limit = null, string pageToken = null)
        {
             ApiResponse<DocList> localVarResponse = ListDocsWithHttpInfo(isOwner, query, sourceDoc, isStarred, inGallery, workspaceId, folderId, limit, pageToken);
             return localVarResponse.Data;
        }
        ...
        /// <param name="pageToken">An opaque token used to fetch the next page of results. (optional)</param>
        /// <returns>ApiResponse of DocList</returns>
        public ApiResponse< DocList > ListDocsWithHttpInfo (bool? isOwner = null, string query = null, string sourceDoc = null, bool? isStarred = null, bool? inGallery = null, string workspaceId = null, string folderId = null, int? limit = null, string pageToken = null)
        {
            ...
            if (isOwner != null) localVarQueryParams.AddRange(this.Configuration.ApiClient.ParameterToKeyValuePairs("", "isOwner", isOwner)); // query parameter
            ...
            if (sourceDoc != null) localVarQueryParams.AddRange(this.Configuration.ApiClient.ParameterToKeyValuePairs("", "sourceDoc", sourceDoc)); // query parameter
            if (isStarred != null) localVarQueryParams.AddRange(this.Configuration.ApiClient.ParameterToKeyValuePairs("", "isStarred", isStarred)); // query parameter
            if (inGallery != null) localVarQueryParams.AddRange(this.Configuration.ApiClient.ParameterToKeyValuePairs("", "inGallery", inGallery)); // query parameter
            if (workspaceId != null) localVarQueryParams.AddRange(this.Configuration.ApiClient.ParameterToKeyValuePairs("", "workspaceId", workspaceId)); // query parameter
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("ListDocs", localVarResponse);
                if (exception != null) throw exception;
            }

            return new ApiResponse<DocList>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => string.Join(",", x.Value)),
                (DocList) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(DocList)));
        }
        ...
        /// <param name="pageToken">An opaque token used to fetch the next page of results. (optional)</param>
        /// <returns>Task of DocList</returns>
        public async System.Threading.Tasks.Task<DocList> ListDocsAsync (bool? isOwner = null, string query = null, string sourceDoc = null, bool? isStarred = null, bool? inGallery = null, string workspaceId = null, string folderId = null, int? limit = null, string pageToken = null)
        {
             ApiResponse<DocList> localVarResponse = await ListDocsAsyncWithHttpInfo(isOwner, query, sourceDoc, isStarred, inGallery, workspaceId, folderId, limit, pageToken);
             return localVarResponse.Data;
        ...
        /// <param name="pageToken">An opaque token used to fetch the next page of results. (optional)</param>
        /// <returns>Task of ApiResponse (DocList)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<DocList>> ListDocsAsyncWithHttpInfo (bool? isOwner = null, string query = null, string sourceDoc = null, bool? isStarred = null, bool? inGallery = null, string workspaceId = null, string folderId = null, int? limit = null, string pageToken = null)
        {
