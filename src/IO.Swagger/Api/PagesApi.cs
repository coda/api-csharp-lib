...
namespace IO.Swagger.Api
{
    ...
    /// </summary>
        public interface IPagesApi : IApiAccessor
    {
        ...
        /// <param name="pageIdOrName">ID or name of the page. Names are discouraged because they&#x27;re easily prone to being changed by users. If you&#x27;re using a name, be sure to URI-encode it. If you provide a name and there are multiple pages with the same name, an arbitrary one will be selected. </param>
        ...
        ApiResponse<Page> GetPageWithHttpInfo (string docId, string pageIdOrName);
        /// <summary>
        /// List pages
        /// </summary>
        /// <remarks>
        ...
        /// <param name="limit">Maximum number of results to return in this query. (optional)</param>
        /// <param name="pageToken">An opaque token used to fetch the next page of results. (optional)</param>
        /// <returns>ApiResponse of PageList</returns>
        ApiResponse<PageList> ListPagesWithHttpInfo (string docId, int? limit = null, string pageToken = null);
        /// <summary>
        /// Update a page
        /// </summary>
        /// <remarks>
        ...
        /// </remarks>
        /// <exception cref="IO.Swagger.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="body">Parameters for updating a page.</param>
        /// <param name="docId">ID of the doc.</param>
        /// <param name="pageIdOrName">ID or name of the page. Names are discouraged because they&#x27;re easily prone to being changed by users. If you&#x27;re using a name, be sure to URI-encode it. If you provide a name and there are multiple pages with the same name, an arbitrary one will be selected. </param>
        /// <returns>PageUpdateResult</returns>
        ...
        /// <param name="docId">ID of the doc.</param>
        /// <param name="pageIdOrName">ID or name of the page. Names are discouraged because they&#x27;re easily prone to being changed by users. If you&#x27;re using a name, be sure to URI-encode it. If you provide a name and there are multiple pages with the same name, an arbitrary one will be selected. </param>
        /// <returns>ApiResponse of PageUpdateResult</returns>
        ApiResponse<PageUpdateResult> UpdatePageWithHttpInfo (PageUpdate body, string docId, string pageIdOrName);
        ...
        System.Threading.Tasks.Task<Page> GetPageAsync (string docId, string pageIdOrName);
        ...
        System.Threading.Tasks.Task<ApiResponse<Page>> GetPageAsyncWithHttpInfo (string docId, string pageIdOrName);
        /// <summary>
        /// List pages
        /// </summary>
        /// <remarks>
        ...
        /// <param name="limit">Maximum number of results to return in this query. (optional)</param>
        /// <param name="pageToken">An opaque token used to fetch the next page of results. (optional)</param>
        /// <returns>Task of PageList</returns>
        System.Threading.Tasks.Task<PageList> ListPagesAsync (string docId, int? limit = null, string pageToken = null);
        ...
        /// <param name="limit">Maximum number of results to return in this query. (optional)</param>
        /// <param name="pageToken">An opaque token used to fetch the next page of results. (optional)</param>
        /// <returns>Task of ApiResponse (PageList)</returns>
        System.Threading.Tasks.Task<ApiResponse<PageList>> ListPagesAsyncWithHttpInfo (string docId, int? limit = null, string pageToken = null);
        /// <summary>
        /// Update a page
        /// </summary>
        /// <remarks>
        ...
        /// <param name="docId">ID of the doc.</param>
        /// <param name="pageIdOrName">ID or name of the page. Names are discouraged because they&#x27;re easily prone to being changed by users. If you&#x27;re using a name, be sure to URI-encode it. If you provide a name and there are multiple pages with the same name, an arbitrary one will be selected. </param>
        /// <returns>Task of PageUpdateResult</returns>
        System.Threading.Tasks.Task<PageUpdateResult> UpdatePageAsync (PageUpdate body, string docId, string pageIdOrName);
        ...
        /// <param name="docId">ID of the doc.</param>
        /// <param name="pageIdOrName">ID or name of the page. Names are discouraged because they&#x27;re easily prone to being changed by users. If you&#x27;re using a name, be sure to URI-encode it. If you provide a name and there are multiple pages with the same name, an arbitrary one will be selected. </param>
        /// <returns>Task of ApiResponse (PageUpdateResult)</returns>
        System.Threading.Tasks.Task<ApiResponse<PageUpdateResult>> UpdatePageAsyncWithHttpInfo (PageUpdate body, string docId, string pageIdOrName);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
        public partial class PagesApi : IPagesApi
    {
        ...
        /// </summary>
        /// <returns></returns>
        public PagesApi(String basePath)
        {
        ...
        /// <returns></returns>
        public PagesApi(IO.Swagger.Client.Configuration configuration = null)
        {
        ...
        /// <param name="pageIdOrName">ID or name of the page. Names are discouraged because they&#x27;re easily prone to being changed by users. If you&#x27;re using a name, be sure to URI-encode it. If you provide a name and there are multiple pages with the same name, an arbitrary one will be selected. </param>
        /// <returns>Page</returns>
        public Page GetPage (string docId, string pageIdOrName)
        {
             ApiResponse<Page> localVarResponse = GetPageWithHttpInfo(docId, pageIdOrName);
        ...
        /// <param name="pageIdOrName">ID or name of the page. Names are discouraged because they&#x27;re easily prone to being changed by users. If you&#x27;re using a name, be sure to URI-encode it. If you provide a name and there are multiple pages with the same name, an arbitrary one will be selected. </param>
        /// <returns>ApiResponse of Page</returns>
        public ApiResponse< Page > GetPageWithHttpInfo (string docId, string pageIdOrName)
        {
            // verify the required parameter 'docId' is set
            if (docId == null)
                throw new ApiException(400, "Missing required parameter 'docId' when calling PagesApi->GetPage");
            // verify the required parameter 'pageIdOrName' is set
            if (pageIdOrName == null)
                throw new ApiException(400, "Missing required parameter 'pageIdOrName' when calling PagesApi->GetPage");

            var localVarPath = "/docs/{docId}/pages/{pageIdOrName}";
            ...
            if (pageIdOrName != null) localVarPathParams.Add("pageIdOrName", this.Configuration.ApiClient.ParameterToString(pageIdOrName)); // path parameter
        ...
        /// <param name="pageIdOrName">ID or name of the page. Names are discouraged because they&#x27;re easily prone to being changed by users. If you&#x27;re using a name, be sure to URI-encode it. If you provide a name and there are multiple pages with the same name, an arbitrary one will be selected. </param>
        /// <returns>Task of Page</returns>
        public async System.Threading.Tasks.Task<Page> GetPageAsync (string docId, string pageIdOrName)
        {
             ApiResponse<Page> localVarResponse = await GetPageAsyncWithHttpInfo(docId, pageIdOrName);
             return localVarResponse.Data;
        ...
        /// <param name="pageIdOrName">ID or name of the page. Names are discouraged because they&#x27;re easily prone to being changed by users. If you&#x27;re using a name, be sure to URI-encode it. If you provide a name and there are multiple pages with the same name, an arbitrary one will be selected. </param>
        /// <returns>Task of ApiResponse (Page)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Page>> GetPageAsyncWithHttpInfo (string docId, string pageIdOrName)
        {
            // verify the required parameter 'docId' is set
            if (docId == null)
                throw new ApiException(400, "Missing required parameter 'docId' when calling PagesApi->GetPage");
        ...
        /// <param name="pageToken">An opaque token used to fetch the next page of results. (optional)</param>
        /// <returns>PageList</returns>
        public PageList ListPages (string docId, int? limit = null, string pageToken = null)
        {
             ApiResponse<PageList> localVarResponse = ListPagesWithHttpInfo(docId, limit, pageToken);
             return localVarResponse.Data;
        }
        ...
        /// <param name="pageToken">An opaque token used to fetch the next page of results. (optional)</param>
        /// <returns>ApiResponse of PageList</returns>
        public ApiResponse< PageList > ListPagesWithHttpInfo (string docId, int? limit = null, string pageToken = null)
        {
            // verify the required parameter 'docId' is set
            if (docId == null)
                throw new ApiException(400, "Missing required parameter 'docId' when calling PagesApi->ListPages");

            var localVarPath = "/docs/{docId}/pages";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new List<KeyValuePair<String, String>>();
            var localVarHeaderParams = new Dictionary<String, String>(this.Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
            ...
            return new ApiResponse<PageList>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => string.Join(",", x.Value)),
                (PageList) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(PageList)));
        }
        ...
        /// <param name="pageToken">An opaque token used to fetch the next page of results. (optional)</param>
        /// <returns>Task of PageList</returns>
        public async System.Threading.Tasks.Task<PageList> ListPagesAsync (string docId, int? limit = null, string pageToken = null)
        {
             ApiResponse<PageList> localVarResponse = await ListPagesAsyncWithHttpInfo(docId, limit, pageToken);
             return localVarResponse.Data;
        ...
        /// <param name="pageToken">An opaque token used to fetch the next page of results. (optional)</param>
        /// <returns>Task of ApiResponse (PageList)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<PageList>> ListPagesAsyncWithHttpInfo (string docId, int? limit = null, string pageToken = null)
        {
            // verify the required parameter 'docId' is set
            if (docId == null)
                throw new ApiException(400, "Missing required parameter 'docId' when calling PagesApi->ListPages");
        ...
        /// <summary>
        /// Update a page Update properties for a page.
        /// </summary>
        /// <exception cref="IO.Swagger.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="body">Parameters for updating a page.</param>
        /// <param name="docId">ID of the doc.</param>
        /// <param name="pageIdOrName">ID or name of the page. Names are discouraged because they&#x27;re easily prone to being changed by users. If you&#x27;re using a name, be sure to URI-encode it. If you provide a name and there are multiple pages with the same name, an arbitrary one will be selected. </param>
        /// <returns>PageUpdateResult</returns>
        public PageUpdateResult UpdatePage (PageUpdate body, string docId, string pageIdOrName)
        {
             ApiResponse<PageUpdateResult> localVarResponse = UpdatePageWithHttpInfo(body, docId, pageIdOrName);
             return localVarResponse.Data;
        }
        ...
        /// <param name="pageIdOrName">ID or name of the page. Names are discouraged because they&#x27;re easily prone to being changed by users. If you&#x27;re using a name, be sure to URI-encode it. If you provide a name and there are multiple pages with the same name, an arbitrary one will be selected. </param>
        /// <returns>ApiResponse of PageUpdateResult</returns>
        public ApiResponse< PageUpdateResult > UpdatePageWithHttpInfo (PageUpdate body, string docId, string pageIdOrName)
        {
            // verify the required parameter 'body' is set
            if (body == null)
                throw new ApiException(400, "Missing required parameter 'body' when calling PagesApi->UpdatePage");
            // verify the required parameter 'docId' is set
            if (docId == null)
                throw new ApiException(400, "Missing required parameter 'docId' when calling PagesApi->UpdatePage");
            // verify the required parameter 'pageIdOrName' is set
            if (pageIdOrName == null)
                throw new ApiException(400, "Missing required parameter 'pageIdOrName' when calling PagesApi->UpdatePage");
            ...
            return new ApiResponse<PageUpdateResult>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => string.Join(",", x.Value)),
                (PageUpdateResult) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(PageUpdateResult)));
        }
        ...
        /// <param name="pageIdOrName">ID or name of the page. Names are discouraged because they&#x27;re easily prone to being changed by users. If you&#x27;re using a name, be sure to URI-encode it. If you provide a name and there are multiple pages with the same name, an arbitrary one will be selected. </param>
        /// <returns>Task of PageUpdateResult</returns>
        public async System.Threading.Tasks.Task<PageUpdateResult> UpdatePageAsync (PageUpdate body, string docId, string pageIdOrName)
        {
             ApiResponse<PageUpdateResult> localVarResponse = await UpdatePageAsyncWithHttpInfo(body, docId, pageIdOrName);
             return localVarResponse.Data;
        ...
        /// <param name="pageIdOrName">ID or name of the page. Names are discouraged because they&#x27;re easily prone to being changed by users. If you&#x27;re using a name, be sure to URI-encode it. If you provide a name and there are multiple pages with the same name, an arbitrary one will be selected. </param>
        /// <returns>Task of ApiResponse (PageUpdateResult)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<PageUpdateResult>> UpdatePageAsyncWithHttpInfo (PageUpdate body, string docId, string pageIdOrName)
        {
            // verify the required parameter 'body' is set
            if (body == null)
                throw new ApiException(400, "Missing required parameter 'body' when calling PagesApi->UpdatePage");
