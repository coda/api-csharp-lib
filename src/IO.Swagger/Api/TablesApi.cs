...
namespace IO.Swagger.Api
{
        ...
        public interface ITablesApi : IApiAccessor
    {
        ...
        ApiResponse<Table> GetTableWithHttpInfo (string docId, string tableIdOrName);
        /// <summary>
        /// List tables
        /// </summary>
        /// <remarks>
        ...
        /// <param name="tableTypes">Comma-separated list of table types to include in results. If omitted, includes both tables and views. (optional)</param>
        /// <returns>TableList</returns>
        ...
        /// <param name="sortBy">Determines how to sort the given objects. (optional)</param>
        /// <param name="tableTypes">Comma-separated list of table types to include in results. If omitted, includes both tables and views. (optional)</param>
        /// <returns>ApiResponse of TableList</returns>
        ApiResponse<TableList> ListTablesWithHttpInfo (string docId, int? limit = null, string pageToken = null, SortBy sortBy = null, List<TableType> tableTypes = null);
        ...
        System.Threading.Tasks.Task<Table> GetTableAsync (string docId, string tableIdOrName);
        ...
        System.Threading.Tasks.Task<ApiResponse<Table>> GetTableAsyncWithHttpInfo (string docId, string tableIdOrName);
        /// <summary>
        /// List tables
        /// </summary>
        /// <remarks>
        ...
        /// <param name="sortBy">Determines how to sort the given objects. (optional)</param>
        /// <param name="tableTypes">Comma-separated list of table types to include in results. If omitted, includes both tables and views. (optional)</param>
        /// <returns>Task of TableList</returns>
        System.Threading.Tasks.Task<TableList> ListTablesAsync (string docId, int? limit = null, string pageToken = null, SortBy sortBy = null, List<TableType> tableTypes = null);
        ...
        /// <param name="sortBy">Determines how to sort the given objects. (optional)</param>
        /// <param name="tableTypes">Comma-separated list of table types to include in results. If omitted, includes both tables and views. (optional)</param>
        /// <returns>Task of ApiResponse (TableList)</returns>
        System.Threading.Tasks.Task<ApiResponse<TableList>> ListTablesAsyncWithHttpInfo (string docId, int? limit = null, string pageToken = null, SortBy sortBy = null, List<TableType> tableTypes = null);
        ...
        public partial class TablesApi : ITablesApi
    {
        ...
        /// <returns></returns>
        public TablesApi(IO.Swagger.Client.Configuration configuration = null)
        {
        ...
        /// <param name="tableIdOrName">ID or name of the table. Names are discouraged because they&#x27;re easily prone to being changed by users. If you&#x27;re using a name, be sure to URI-encode it.</param>
        /// <returns>Table</returns>
        public Table GetTable (string docId, string tableIdOrName)
        {
             ApiResponse<Table> localVarResponse = GetTableWithHttpInfo(docId, tableIdOrName);
        ...
        /// <param name="tableIdOrName">ID or name of the table. Names are discouraged because they&#x27;re easily prone to being changed by users. If you&#x27;re using a name, be sure to URI-encode it.</param>
        /// <returns>ApiResponse of Table</returns>
        public ApiResponse< Table > GetTableWithHttpInfo (string docId, string tableIdOrName)
        {
            // verify the required parameter 'docId' is set
            if (docId == null)
                throw new ApiException(400, "Missing required parameter 'docId' when calling TablesApi->GetTable");
            // verify the required parameter 'tableIdOrName' is set
            if (tableIdOrName == null)
                throw new ApiException(400, "Missing required parameter 'tableIdOrName' when calling TablesApi->GetTable");

            var localVarPath = "/docs/{docId}/tables/{tableIdOrName}";
        ...
        /// <param name="tableIdOrName">ID or name of the table. Names are discouraged because they&#x27;re easily prone to being changed by users. If you&#x27;re using a name, be sure to URI-encode it.</param>
        /// <returns>Task of Table</returns>
        public async System.Threading.Tasks.Task<Table> GetTableAsync (string docId, string tableIdOrName)
        {
             ApiResponse<Table> localVarResponse = await GetTableAsyncWithHttpInfo(docId, tableIdOrName);
             return localVarResponse.Data;
        ...
        /// <param name="tableIdOrName">ID or name of the table. Names are discouraged because they&#x27;re easily prone to being changed by users. If you&#x27;re using a name, be sure to URI-encode it.</param>
        /// <returns>Task of ApiResponse (Table)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Table>> GetTableAsyncWithHttpInfo (string docId, string tableIdOrName)
        {
            // verify the required parameter 'docId' is set
            if (docId == null)
                throw new ApiException(400, "Missing required parameter 'docId' when calling TablesApi->GetTable");
        ...
        /// <param name="tableTypes">Comma-separated list of table types to include in results. If omitted, includes both tables and views. (optional)</param>
        /// <returns>TableList</returns>
        public TableList ListTables (string docId, int? limit = null, string pageToken = null, SortBy sortBy = null, List<TableType> tableTypes = null)
        {
             ApiResponse<TableList> localVarResponse = ListTablesWithHttpInfo(docId, limit, pageToken, sortBy, tableTypes);
             return localVarResponse.Data;
        }
        ...
        /// <param name="tableTypes">Comma-separated list of table types to include in results. If omitted, includes both tables and views. (optional)</param>
        /// <returns>ApiResponse of TableList</returns>
        public ApiResponse< TableList > ListTablesWithHttpInfo (string docId, int? limit = null, string pageToken = null, SortBy sortBy = null, List<TableType> tableTypes = null)
        {
            // verify the required parameter 'docId' is set
            if (docId == null)
                throw new ApiException(400, "Missing required parameter 'docId' when calling TablesApi->ListTables");

            var localVarPath = "/docs/{docId}/tables";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new List<KeyValuePair<String, String>>();
            var localVarHeaderParams = new Dictionary<String, String>(this.Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
            ...
            if (tableTypes != null) localVarQueryParams.AddRange(this.Configuration.ApiClient.ParameterToKeyValuePairs("csv", "tableTypes", tableTypes)); // query parameter
            // authentication (Bearer) required
            // bearer required
            if (!String.IsNullOrEmpty(this.Configuration.AccessToken))
            {
            ...
            return new ApiResponse<TableList>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => string.Join(",", x.Value)),
                (TableList) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(TableList)));
        }
        ...
        /// <param name="tableTypes">Comma-separated list of table types to include in results. If omitted, includes both tables and views. (optional)</param>
        /// <returns>Task of TableList</returns>
        public async System.Threading.Tasks.Task<TableList> ListTablesAsync (string docId, int? limit = null, string pageToken = null, SortBy sortBy = null, List<TableType> tableTypes = null)
        {
             ApiResponse<TableList> localVarResponse = await ListTablesAsyncWithHttpInfo(docId, limit, pageToken, sortBy, tableTypes);
             return localVarResponse.Data;
        ...
        /// <param name="tableTypes">Comma-separated list of table types to include in results. If omitted, includes both tables and views. (optional)</param>
        /// <returns>Task of ApiResponse (TableList)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<TableList>> ListTablesAsyncWithHttpInfo (string docId, int? limit = null, string pageToken = null, SortBy sortBy = null, List<TableType> tableTypes = null)
        {
            // verify the required parameter 'docId' is set
            if (docId == null)
                throw new ApiException(400, "Missing required parameter 'docId' when calling TablesApi->ListTables");
