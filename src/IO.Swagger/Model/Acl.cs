...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class Acl :  IEquatable<Acl>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Acl" /> class.
        /// </summary>
        /// <param name="items">items (required).</param>
        /// <param name="href">API link to these results (required).</param>
        /// <param name="nextPageToken">nextPageToken.</param>
        /// <param name="nextPageLink">nextPageLink.</param>
        public Acl(List<Permission> items = default(List<Permission>), string href = default(string), NextPageToken nextPageToken = default(NextPageToken), AllOfAclNextPageLink nextPageLink = default(AllOfAclNextPageLink))
        {
            // to ensure "items" is required (not null)
            if (items == null)
            {
                throw new InvalidDataException("items is a required property for Acl and cannot be null");
            }
            else
            {
                this.Items = items;
            ...
            if (href == null)
            {
                throw new InvalidDataException("href is a required property for Acl and cannot be null");
            }
            else
            {
                this.Href = href;
        ...
        public AllOfAclNextPageLink NextPageLink { get; set; }
        ...
        {
            return this.Equals(input as Acl);
        }

        /// <summary>
        /// Returns true if Acl instances are equal
        /// </summary>
        /// <param name="input">Instance of Acl to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Acl input)
        {
            if (input == null)
                return false;
