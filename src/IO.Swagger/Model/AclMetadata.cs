...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class AclMetadata :  IEquatable<AclMetadata>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AclMetadata" /> class.
        /// </summary>
        /// <param name="canShare">When true, the user of the api can share (required).</param>
        /// <param name="canShareWithOrg">When true, the user of the api can share with the org (required).</param>
        public AclMetadata(bool? canShare = default(bool?), bool? canShareWithOrg = default(bool?))
        {
            // to ensure "canShare" is required (not null)
            if (canShare == null)
            {
                throw new InvalidDataException("canShare is a required property for AclMetadata and cannot be null");
            }
            else
            {
                this.CanShare = canShare;
            }
            // to ensure "canShareWithOrg" is required (not null)
            if (canShareWithOrg == null)
            {
                throw new InvalidDataException("canShareWithOrg is a required property for AclMetadata and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        /// <value>When true, the user of the api can share</value>
        ...
        /// </summary>
        /// <value>When true, the user of the api can share with the org</value>
        [DataMember(Name="canShareWithOrg", EmitDefaultValue=false)]
        public bool? CanShareWithOrg { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AclMetadata {\n");
            sb.Append("  CanShare: ").Append(CanShare).Append("\n");
            sb.Append("  CanShareWithOrg: ").Append(CanShareWithOrg).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as AclMetadata);
        }

        /// <summary>
        /// Returns true if AclMetadata instances are equal
        /// </summary>
        /// <param name="input">Instance of AclMetadata to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AclMetadata input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.CanShare == input.CanShare ||
                    (this.CanShare != null &&
                    this.CanShare.Equals(input.CanShare))
                ) && 
                (
                    this.CanShareWithOrg == input.CanShareWithOrg ||
                    (this.CanShareWithOrg != null &&
                    this.CanShareWithOrg.Equals(input.CanShareWithOrg))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.CanShare != null)
                    hashCode = hashCode * 59 + this.CanShare.GetHashCode();
                if (this.CanShareWithOrg != null)
                    hashCode = hashCode * 59 + this.CanShareWithOrg.GetHashCode();
                return hashCode;
            }
        }
