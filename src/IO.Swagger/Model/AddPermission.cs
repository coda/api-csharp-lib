...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class AddPermission :  IEquatable<AddPermission>, IValidatableObject
    {
        /// <summary>
        /// Gets or Sets Access
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AddPermission" /> class.
        /// </summary>
        /// <param name="access">access (required).</param>
        /// <param name="principal">principal (required).</param>
        /// <param name="suppressEmail">When true suppresses email notification.</param>
        public AddPermission(AccessType access = default(AccessType), Principal principal = default(Principal), bool? suppressEmail = default(bool?))
        {
            // to ensure "access" is required (not null)
            if (access == null)
            {
                throw new InvalidDataException("access is a required property for AddPermission and cannot be null");
            }
            else
            {
                this.Access = access;
            ...
            if (principal == null)
            {
                throw new InvalidDataException("principal is a required property for AddPermission and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        /// <value>When true suppresses email notification</value>
        [DataMember(Name="suppressEmail", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  SuppressEmail: ").Append(SuppressEmail).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as AddPermission);
        }

        /// <summary>
        /// Returns true if AddPermission instances are equal
        /// </summary>
        /// <param name="input">Instance of AddPermission to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AddPermission input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.SuppressEmail == input.SuppressEmail ||
                    (this.SuppressEmail != null &&
                    this.SuppressEmail.Equals(input.SuppressEmail))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.SuppressEmail != null)
                    hashCode = hashCode * 59 + this.SuppressEmail.GetHashCode();
                return hashCode;
            }
        }
