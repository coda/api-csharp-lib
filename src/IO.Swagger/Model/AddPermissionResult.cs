...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class AddPermissionResult :  IEquatable<AddPermissionResult>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AddPermissionResult" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AddPermissionResult {\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as AddPermissionResult);
        }

        /// <summary>
        /// Returns true if AddPermissionResult instances are equal
        /// </summary>
        /// <param name="input">Instance of AddPermissionResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AddPermissionResult input)
        {
            if (input == null)
                return false;
