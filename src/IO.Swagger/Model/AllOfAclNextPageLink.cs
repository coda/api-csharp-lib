...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class AllOfAclNextPageLink : NextPageLink,  IEquatable<AllOfAclNextPageLink>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AllOfAclNextPageLink" /> class.
        /// </summary>
        public AllOfAclNextPageLink() : base()
        {
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AllOfAclNextPageLink {\n");
        ...
        {
            return this.Equals(input as AllOfAclNextPageLink);
        }

        /// <summary>
        /// Returns true if AllOfAclNextPageLink instances are equal
        /// </summary>
        /// <param name="input">Instance of AllOfAclNextPageLink to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AllOfAclNextPageLink input)
        {
            if (input == null)
                return false;
