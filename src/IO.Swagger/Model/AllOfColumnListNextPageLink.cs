...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class AllOfColumnListNextPageLink : NextPageLink,  IEquatable<AllOfColumnListNextPageLink>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AllOfColumnListNextPageLink" /> class.
        /// </summary>
        public AllOfColumnListNextPageLink() : base()
        {
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AllOfColumnListNextPageLink {\n");
        ...
        {
            return this.Equals(input as AllOfColumnListNextPageLink);
        }

        /// <summary>
        /// Returns true if AllOfColumnListNextPageLink instances are equal
        /// </summary>
        /// <param name="input">Instance of AllOfColumnListNextPageLink to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AllOfColumnListNextPageLink input)
        {
            if (input == null)
                return false;
