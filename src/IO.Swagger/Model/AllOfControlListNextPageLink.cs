...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class AllOfControlListNextPageLink : NextPageLink,  IEquatable<AllOfControlListNextPageLink>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AllOfControlListNextPageLink" /> class.
        /// </summary>
        public AllOfControlListNextPageLink() : base()
        {
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AllOfControlListNextPageLink {\n");
        ...
        {
            return this.Equals(input as AllOfControlListNextPageLink);
        }

        /// <summary>
        /// Returns true if AllOfControlListNextPageLink instances are equal
        /// </summary>
        /// <param name="input">Instance of AllOfControlListNextPageLink to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AllOfControlListNextPageLink input)
        {
            if (input == null)
                return false;
