...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class AllOfDocListNextPageLink : NextPageLink,  IEquatable<AllOfDocListNextPageLink>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AllOfDocListNextPageLink" /> class.
        /// </summary>
        public AllOfDocListNextPageLink() : base()
        {
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AllOfDocListNextPageLink {\n");
        ...
        {
            return this.Equals(input as AllOfDocListNextPageLink);
        }

        /// <summary>
        /// Returns true if AllOfDocListNextPageLink instances are equal
        /// </summary>
        /// <param name="input">Instance of AllOfDocListNextPageLink to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AllOfDocListNextPageLink input)
        {
            if (input == null)
                return false;
