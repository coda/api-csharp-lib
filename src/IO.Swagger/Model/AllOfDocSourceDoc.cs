...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class AllOfDocSourceDoc :  IEquatable<AllOfDocSourceDoc>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AllOfDocSourceDoc" /> class.
        /// </summary>
        ...
        public AllOfDocSourceDoc(string id = default(string), TypeEnum type = default(TypeEnum), string href = default(string), string browserLink = default(string))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new InvalidDataException("id is a required property for AllOfDocSourceDoc and cannot be null");
            }
            else
            {
                this.Id = id;
            ...
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for AllOfDocSourceDoc and cannot be null");
            }
            else
            {
                this.Type = type;
            ...
            if (href == null)
            {
                throw new InvalidDataException("href is a required property for AllOfDocSourceDoc and cannot be null");
            }
            else
            {
                this.Href = href;
            ...
            if (browserLink == null)
            {
                throw new InvalidDataException("browserLink is a required property for AllOfDocSourceDoc and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AllOfDocSourceDoc {\n");
        ...
        {
            return this.Equals(input as AllOfDocSourceDoc);
        }

        /// <summary>
        /// Returns true if AllOfDocSourceDoc instances are equal
        /// </summary>
        /// <param name="input">Instance of AllOfDocSourceDoc to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AllOfDocSourceDoc input)
        {
            if (input == null)
                return false;
