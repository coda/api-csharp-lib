...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class AllOfFormulaListNextPageLink : NextPageLink,  IEquatable<AllOfFormulaListNextPageLink>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AllOfFormulaListNextPageLink" /> class.
        /// </summary>
        public AllOfFormulaListNextPageLink() : base()
        {
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AllOfFormulaListNextPageLink {\n");
        ...
        {
            return this.Equals(input as AllOfFormulaListNextPageLink);
        }

        /// <summary>
        /// Returns true if AllOfFormulaListNextPageLink instances are equal
        /// </summary>
        /// <param name="input">Instance of AllOfFormulaListNextPageLink to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AllOfFormulaListNextPageLink input)
        {
            if (input == null)
                return false;
