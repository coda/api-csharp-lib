...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class AllOfPageListNextPageLink : NextPageLink,  IEquatable<AllOfPageListNextPageLink>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AllOfPageListNextPageLink" /> class.
        /// </summary>
        public AllOfPageListNextPageLink() : base()
        {
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AllOfPageListNextPageLink {\n");
        ...
        {
            return this.Equals(input as AllOfPageListNextPageLink);
        }

        /// <summary>
        /// Returns true if AllOfPageListNextPageLink instances are equal
        /// </summary>
        /// <param name="input">Instance of AllOfPageListNextPageLink to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AllOfPageListNextPageLink input)
        {
            if (input == null)
                return false;
