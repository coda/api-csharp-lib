...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class AllOfRowListNextPageLink : NextPageLink,  IEquatable<AllOfRowListNextPageLink>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AllOfRowListNextPageLink" /> class.
        /// </summary>
        public AllOfRowListNextPageLink() : base()
        {
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AllOfRowListNextPageLink {\n");
        ...
        {
            return this.Equals(input as AllOfRowListNextPageLink);
        }

        /// <summary>
        /// Returns true if AllOfRowListNextPageLink instances are equal
        /// </summary>
        /// <param name="input">Instance of AllOfRowListNextPageLink to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AllOfRowListNextPageLink input)
        {
            if (input == null)
                return false;
