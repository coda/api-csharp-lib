...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class AllOfTableFilter :  IEquatable<AllOfTableFilter>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AllOfTableFilter" /> class.
        /// </summary>
        /// <param name="valid">Returns whether or not the given formula is valid. (required).</param>
        /// <param name="isVolatile">Returns whether or not the given formula can return different results in different contexts (for example, for different users). .</param>
        /// <param name="hasUserFormula">Returns whether or not the given formula has a User() formula within it..</param>
        /// <param name="hasTodayFormula">Returns whether or not the given formula has a Today() formula within it..</param>
        /// <param name="hasNowFormula">Returns whether or not the given formula has a Now() formula within it..</param>
        public AllOfTableFilter(bool? valid = default(bool?), bool? isVolatile = default(bool?), bool? hasUserFormula = default(bool?), bool? hasTodayFormula = default(bool?), bool? hasNowFormula = default(bool?))
        {
            // to ensure "valid" is required (not null)
            if (valid == null)
            {
                throw new InvalidDataException("valid is a required property for AllOfTableFilter and cannot be null");
            }
            else
            {
                this.Valid = valid;
        ...
        /// </summary>
        /// <value>Returns whether or not the given formula is valid.</value>
        ...
        /// </summary>
        /// <value>Returns whether or not the given formula can return different results in different contexts (for example, for different users). </value>
        ...
        /// </summary>
        /// <value>Returns whether or not the given formula has a User() formula within it.</value>
        [DataMember(Name="hasUserFormula", EmitDefaultValue=false)]
        public bool? HasUserFormula { get; set; }

        /// <summary>
        /// Returns whether or not the given formula has a Today() formula within it.
        /// </summary>
        /// <value>Returns whether or not the given formula has a Today() formula within it.</value>
        [DataMember(Name="hasTodayFormula", EmitDefaultValue=false)]
        public bool? HasTodayFormula { get; set; }

        /// <summary>
        /// Returns whether or not the given formula has a Now() formula within it.
        /// </summary>
        /// <value>Returns whether or not the given formula has a Now() formula within it.</value>
        [DataMember(Name="hasNowFormula", EmitDefaultValue=false)]
        public bool? HasNowFormula { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AllOfTableFilter {\n");
            sb.Append("  Valid: ").Append(Valid).Append("\n");
            sb.Append("  IsVolatile: ").Append(IsVolatile).Append("\n");
            sb.Append("  HasUserFormula: ").Append(HasUserFormula).Append("\n");
            sb.Append("  HasTodayFormula: ").Append(HasTodayFormula).Append("\n");
            sb.Append("  HasNowFormula: ").Append(HasNowFormula).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as AllOfTableFilter);
        }

        /// <summary>
        /// Returns true if AllOfTableFilter instances are equal
        /// </summary>
        /// <param name="input">Instance of AllOfTableFilter to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AllOfTableFilter input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.IsVolatile == input.IsVolatile ||
                    (this.IsVolatile != null &&
                    this.IsVolatile.Equals(input.IsVolatile))
                ) && 
                (
                    this.HasUserFormula == input.HasUserFormula ||
                    (this.HasUserFormula != null &&
                    this.HasUserFormula.Equals(input.HasUserFormula))
                ) && 
                (
                    this.HasTodayFormula == input.HasTodayFormula ||
                    (this.HasTodayFormula != null &&
                    this.HasTodayFormula.Equals(input.HasTodayFormula))
                ) && 
                (
                    this.HasNowFormula == input.HasNowFormula ||
                    (this.HasNowFormula != null &&
                    this.HasNowFormula.Equals(input.HasNowFormula))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.IsVolatile != null)
                    hashCode = hashCode * 59 + this.IsVolatile.GetHashCode();
                if (this.HasUserFormula != null)
                    hashCode = hashCode * 59 + this.HasUserFormula.GetHashCode();
                if (this.HasTodayFormula != null)
                    hashCode = hashCode * 59 + this.HasTodayFormula.GetHashCode();
                if (this.HasNowFormula != null)
                    hashCode = hashCode * 59 + this.HasNowFormula.GetHashCode();
                return hashCode;
            }
        }
