...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class AllOfTableListNextPageLink : NextPageLink,  IEquatable<AllOfTableListNextPageLink>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AllOfTableListNextPageLink" /> class.
        /// </summary>
        public AllOfTableListNextPageLink() : base()
        {
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AllOfTableListNextPageLink {\n");
        ...
        {
            return this.Equals(input as AllOfTableListNextPageLink);
        }

        /// <summary>
        /// Returns true if AllOfTableListNextPageLink instances are equal
        /// </summary>
        /// <param name="input">Instance of AllOfTableListNextPageLink to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AllOfTableListNextPageLink input)
        {
            if (input == null)
                return false;
