...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class AnyonePrincipal :  IEquatable<AnyonePrincipal>, IValidatableObject
    {
        /// <summary>
        /// Gets or Sets Type
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AnyonePrincipal" /> class.
        /// </summary>
        /// <param name="type">type (required).</param>
        public AnyonePrincipal(PrincipalType type = default(PrincipalType))
        {
            // to ensure "type" is required (not null)
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for AnyonePrincipal and cannot be null");
            }
            else
            {
                this.Type = type;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AnyonePrincipal {\n");
        ...
        {
            return this.Equals(input as AnyonePrincipal);
        }

        /// <summary>
        /// Returns true if AnyonePrincipal instances are equal
        /// </summary>
        /// <param name="input">Instance of AnyonePrincipal to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AnyonePrincipal input)
        {
            if (input == null)
                return false;
