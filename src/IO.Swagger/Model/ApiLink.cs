...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ApiLink :  IEquatable<ApiLink>, IValidatableObject
    {
        /// <summary>
        ...
        {
            /// <summary>
            /// Enum ApiLink for value: apiLink
            /// </summary>
            [EnumMember(Value = "apiLink")]
            ApiLink = 1        }
        /// <summary>
        /// The type of this resource.
        /// </summary>
        ...
        /// <param name="href">Self link to this query. (required).</param>
        /// <param name="browserLink">Canonical browser-friendly link to the resolved resource..</param>
        /// <param name="resource">resource (required).</param>
        public ApiLink(TypeEnum type = default(TypeEnum), string href = default(string), string browserLink = default(string), ApiLinkResolvedResource resource = default(ApiLinkResolvedResource))
        {
            // to ensure "type" is required (not null)
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for ApiLink and cannot be null");
            }
            else
            {
                this.Type = type;
            ...
            if (href == null)
            {
                throw new InvalidDataException("href is a required property for ApiLink and cannot be null");
            }
            else
            {
                this.Href = href;
            ...
            if (resource == null)
            {
                throw new InvalidDataException("resource is a required property for ApiLink and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        /// <value>Self link to this query.</value>
        ...
        /// </summary>
        /// <value>Canonical browser-friendly link to the resolved resource.</value>
        ...
        public ApiLinkResolvedResource Resource { get; set; }
        ...
        /// <summary>
        /// Returns true if ApiLink instances are equal
        /// </summary>
        /// <param name="input">Instance of ApiLink to be compared</param>
        /// <returns>Boolean</returns>
