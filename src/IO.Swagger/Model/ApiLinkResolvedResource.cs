...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ApiLinkResolvedResource :  IEquatable<ApiLinkResolvedResource>, IValidatableObject
    {
        /// <summary>
        /// Gets or Sets Type
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ApiLinkResolvedResource" /> class.
        /// </summary>
        /// <param name="type">type (required).</param>
        /// <param name="id">ID of the resolved resource. (required).</param>
        /// <param name="name">Name of the resource..</param>
        /// <param name="href">API link to the resolved resource that can be queried to get further information. (required).</param>
        public ApiLinkResolvedResource(Type type = default(Type), string id = default(string), string name = default(string), string href = default(string))
        {
            // to ensure "type" is required (not null)
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for ApiLinkResolvedResource and cannot be null");
            }
            else
            {
                this.Type = type;
            ...
            if (id == null)
            {
                throw new InvalidDataException("id is a required property for ApiLinkResolvedResource and cannot be null");
            }
            else
            {
                this.Id = id;
            ...
            if (href == null)
            {
                throw new InvalidDataException("href is a required property for ApiLinkResolvedResource and cannot be null");
            }
            else
            {
                this.Href = href;
        ...
        /// </summary>
        /// <value>ID of the resolved resource.</value>
        ...
        /// </summary>
        /// <value>API link to the resolved resource that can be queried to get further information.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ApiLinkResolvedResource {\n");
        ...
        {
            return this.Equals(input as ApiLinkResolvedResource);
        }

        /// <summary>
        /// Returns true if ApiLinkResolvedResource instances are equal
        /// </summary>
        /// <param name="input">Instance of ApiLinkResolvedResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApiLinkResolvedResource input)
        {
            if (input == null)
                return false;
