...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class CellEdit :  IEquatable<CellEdit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CellEdit" /> class.
        /// </summary>
        /// <param name="column">Column ID, URL, or name (fragile and discouraged) associated with this edit. (required).</param>
        /// <param name="value">value (required).</param>
        public CellEdit(string column = default(string), Value value = default(Value))
        {
            // to ensure "column" is required (not null)
            if (column == null)
            {
                throw new InvalidDataException("column is a required property for CellEdit and cannot be null");
            }
            else
            {
                this.Column = column;
            ...
            if (value == null)
            {
                throw new InvalidDataException("value is a required property for CellEdit and cannot be null");
            }
            else
            {
                this.Value = value;
        ...
        /// </summary>
        /// <value>Column ID, URL, or name (fragile and discouraged) associated with this edit.</value>
        ...
        {
            return this.Equals(input as CellEdit);
        }

        /// <summary>
        /// Returns true if CellEdit instances are equal
        /// </summary>
        /// <param name="input">Instance of CellEdit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CellEdit input)
        {
            if (input == null)
                return false;
