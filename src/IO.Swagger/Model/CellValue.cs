...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class CellValue :  IEquatable<CellValue>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as CellValue);
        }

        /// <summary>
        /// Returns true if CellValue instances are equal
        /// </summary>
        /// <param name="input">Instance of CellValue to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CellValue input)
        {
            if (input == null)
                return false;
