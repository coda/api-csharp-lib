...
namespace IO.Swagger.Model
{
        ...
        public partial class Column :  IEquatable<Column>, IValidatableObject
    {
        ...
        public Column(string id = default(string), TypeEnum type = default(TypeEnum), string href = default(string), string name = default(string), bool? display = default(bool?), bool? calculated = default(bool?), ColumnFormat format = default(ColumnFormat))
        {
            ...
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for Column and cannot be null");
            }
            else
            {
                this.Type = type;
            ...
            if (href == null)
            {
                throw new InvalidDataException("href is a required property for Column and cannot be null");
            }
            else
            {
                this.Href = href;
            ...
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for Column and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            if (format == null)
            {
                throw new InvalidDataException("format is a required property for Column and cannot be null");
            }
            else
            {
                this.Format = format;
