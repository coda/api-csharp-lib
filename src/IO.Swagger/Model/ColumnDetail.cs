...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ColumnDetail :  IEquatable<ColumnDetail>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ColumnDetail" /> class.
        /// </summary>
        /// <param name="id">ID of the column. (required).</param>
        /// <param name="type">The type of this resource. (required).</param>
        /// <param name="href">API link to the column. (required).</param>
        /// <param name="name">Name of the column. (required).</param>
        /// <param name="display">Whether the column is the display column..</param>
        /// <param name="calculated">Whether the column has a formula set on it..</param>
        /// <param name="format">format (required).</param>
        /// <param name="parent">parent (required).</param>
        public ColumnDetail(string id = default(string), TypeEnum type = default(TypeEnum), string href = default(string), string name = default(string), bool? display = default(bool?), bool? calculated = default(bool?), ColumnFormat format = default(ColumnFormat), TableReference parent = default(TableReference))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new InvalidDataException("id is a required property for ColumnDetail and cannot be null");
            }
            else
            {
                this.Id = id;
            ...
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for ColumnDetail and cannot be null");
            }
            else
            {
                this.Type = type;
            ...
            if (href == null)
            {
                throw new InvalidDataException("href is a required property for ColumnDetail and cannot be null");
            }
            else
            {
                this.Href = href;
            ...
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for ColumnDetail and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            if (format == null)
            {
                throw new InvalidDataException("format is a required property for ColumnDetail and cannot be null");
            }
            else
            {
                this.Format = format;
            ...
            if (parent == null)
            {
                throw new InvalidDataException("parent is a required property for ColumnDetail and cannot be null");
            }
            else
            {
                this.Parent = parent;
        ...
        /// </summary>
        /// <value>API link to the column.</value>
        ...
        /// </summary>
        /// <value>Whether the column is the display column.</value>
        ...
        /// </summary>
        /// <value>Whether the column has a formula set on it.</value>
        ...
        {
            return this.Equals(input as ColumnDetail);
        }

        /// <summary>
        /// Returns true if ColumnDetail instances are equal
        /// </summary>
        /// <param name="input">Instance of ColumnDetail to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ColumnDetail input)
        {
            if (input == null)
                return false;
