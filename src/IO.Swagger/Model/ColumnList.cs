...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ColumnList :  IEquatable<ColumnList>, IValidatableObject
    {
        /// <summary>
        ...
        public ColumnList(List<Column> items = default(List<Column>), string href = default(string), NextPageToken nextPageToken = default(NextPageToken), AllOfColumnListNextPageLink nextPageLink = default(AllOfColumnListNextPageLink))
        {
            // to ensure "items" is required (not null)
            if (items == null)
            {
                throw new InvalidDataException("items is a required property for ColumnList and cannot be null");
            }
            else
            {
                this.Items = items;
        ...
        public AllOfColumnListNextPageLink NextPageLink { get; set; }
        ...
        {
            return this.Equals(input as ColumnList);
        }

        /// <summary>
        /// Returns true if ColumnList instances are equal
        /// </summary>
        /// <param name="input">Instance of ColumnList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ColumnList input)
        {
            if (input == null)
                return false;
