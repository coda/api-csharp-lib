...
namespace IO.Swagger.Model
{
        ...
        public partial class ColumnReference :  IEquatable<ColumnReference>, IValidatableObject
    {
        ...
        public ColumnReference(string id = default(string), TypeEnum type = default(TypeEnum), string href = default(string))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new InvalidDataException("id is a required property for ColumnReference and cannot be null");
            }
            else
            {
                this.Id = id;
            ...
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for ColumnReference and cannot be null");
            }
            else
            {
                this.Type = type;
            ...
            if (href == null)
            {
                throw new InvalidDataException("href is a required property for ColumnReference and cannot be null");
            }
            else
            {
                this.Href = href;
