...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class Control :  IEquatable<Control>, IValidatableObject
    {
        /// <summary>
        ...
        public Control(string id = default(string), TypeEnum type = default(TypeEnum), string href = default(string), string name = default(string), PageReference parent = default(PageReference), ControlType controlType = default(ControlType), Value value = default(Value))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new InvalidDataException("id is a required property for Control and cannot be null");
            }
            else
            {
                this.Id = id;
            ...
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for Control and cannot be null");
            }
            else
            {
                this.Type = type;
            ...
            if (href == null)
            {
                throw new InvalidDataException("href is a required property for Control and cannot be null");
            }
            else
            {
                this.Href = href;
            ...
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for Control and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            if (controlType == null)
            {
                throw new InvalidDataException("controlType is a required property for Control and cannot be null");
            }
            else
            {
            ...
            if (value == null)
            {
                throw new InvalidDataException("value is a required property for Control and cannot be null");
            }
            else
            {
                this.Value = value;
        ...
        /// </summary>
        /// <param name="input">Instance of Control to be compared</param>
        /// <returns>Boolean</returns>
