...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ControlList :  IEquatable<ControlList>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ControlList" /> class.
        /// </summary>
        /// <param name="items">items (required).</param>
        /// <param name="href">API link to these results.</param>
        /// <param name="nextPageToken">nextPageToken.</param>
        /// <param name="nextPageLink">nextPageLink.</param>
        public ControlList(List<ControlReference> items = default(List<ControlReference>), string href = default(string), NextPageToken nextPageToken = default(NextPageToken), AllOfControlListNextPageLink nextPageLink = default(AllOfControlListNextPageLink))
        {
            // to ensure "items" is required (not null)
            if (items == null)
            {
                throw new InvalidDataException("items is a required property for ControlList and cannot be null");
            }
            else
            {
                this.Items = items;
        ...
        public List<ControlReference> Items { get; set; }

        /// <summary>
        /// API link to these results
        /// </summary>
        /// <value>API link to these results</value>
        ...
        /// <summary>
        /// Gets or Sets NextPageLink
        /// </summary>
        [DataMember(Name="nextPageLink", EmitDefaultValue=false)]
        public AllOfControlListNextPageLink NextPageLink { get; set; }
        ...
        {
            return this.Equals(input as ControlList);
        }

        /// <summary>
        /// Returns true if ControlList instances are equal
        /// </summary>
        /// <param name="input">Instance of ControlList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ControlList input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.NextPageLink == input.NextPageLink ||
                    (this.NextPageLink != null &&
                    this.NextPageLink.Equals(input.NextPageLink))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.NextPageLink != null)
                    hashCode = hashCode * 59 + this.NextPageLink.GetHashCode();
                return hashCode;
            }
        }
