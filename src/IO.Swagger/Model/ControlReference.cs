...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ControlReference :  IEquatable<ControlReference>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ControlReference" /> class.
        /// </summary>
        /// <param name="id">ID of the control. (required).</param>
        /// <param name="type">The type of this resource. (required).</param>
        /// <param name="href">API link to the control. (required).</param>
        /// <param name="name">Name of the control. (required).</param>
        /// <param name="parent">parent.</param>
        public ControlReference(string id = default(string), TypeEnum type = default(TypeEnum), string href = default(string), string name = default(string), PageReference parent = default(PageReference))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new InvalidDataException("id is a required property for ControlReference and cannot be null");
            }
            else
            {
                this.Id = id;
            ...
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for ControlReference and cannot be null");
            }
            else
            {
                this.Type = type;
            ...
            if (href == null)
            {
                throw new InvalidDataException("href is a required property for ControlReference and cannot be null");
            }
            else
            {
                this.Href = href;
            ...
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for ControlReference and cannot be null");
            }
            else
            {
                this.Name = name;
        ...
        /// </summary>
        /// <value>API link to the control.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ControlReference {\n");
        ...
        {
            return this.Equals(input as ControlReference);
        }

        /// <summary>
        /// Returns true if ControlReference instances are equal
        /// </summary>
        /// <param name="input">Instance of ControlReference to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ControlReference input)
        {
            if (input == null)
                return false;
