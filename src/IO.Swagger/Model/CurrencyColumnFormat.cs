...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class CurrencyColumnFormat : SimpleColumnFormat,  IEquatable<CurrencyColumnFormat>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CurrencyColumnFormat" /> class.
        /// </summary>
        /// <param name="currencyCode">The currency symbol.</param>
        /// <param name="precision">The decimal precision..</param>
        /// <param name="format">format.</param>
        public CurrencyColumnFormat(string currencyCode = default(string), int? precision = default(int?), CurrencyFormatType format = default(CurrencyFormatType), ColumnFormatType type = default(ColumnFormatType), bool? isArray = default(bool?)) : base(type, isArray)
        {
        ...
        public CurrencyFormatType Format { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CurrencyColumnFormat {\n");
        ...
        {
            return this.Equals(input as CurrencyColumnFormat);
        }

        /// <summary>
        /// Returns true if CurrencyColumnFormat instances are equal
        /// </summary>
        /// <param name="input">Instance of CurrencyColumnFormat to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CurrencyColumnFormat input)
        {
            if (input == null)
                return false;
