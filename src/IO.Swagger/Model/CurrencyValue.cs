...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class CurrencyValue : LinkedDataObject,  IEquatable<CurrencyValue>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CurrencyValue" /> class.
        /// </summary>
        /// <param name="currency">The 3-letter currency code. (required).</param>
        /// <param name="amount">amount (required).</param>
        public CurrencyValue(string currency = default(string), CurrencyAmount amount = default(CurrencyAmount), string context = default(string), LinkedDataType type = default(LinkedDataType), string additionalType = default(string)) : base(context, type, additionalType)
        {
            // to ensure "currency" is required (not null)
            if (currency == null)
            {
                throw new InvalidDataException("currency is a required property for CurrencyValue and cannot be null");
            }
            else
            {
            ...
            if (amount == null)
            {
                throw new InvalidDataException("amount is a required property for CurrencyValue and cannot be null");
            }
            else
            {
                this.Amount = amount;
        ...
        /// </summary>
        /// <value>The 3-letter currency code.</value>
        ...
        {
            return this.Equals(input as CurrencyValue);
        }

        /// <summary>
        /// Returns true if CurrencyValue instances are equal
        /// </summary>
        /// <param name="input">Instance of CurrencyValue to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CurrencyValue input)
        {
            if (input == null)
                return false;
