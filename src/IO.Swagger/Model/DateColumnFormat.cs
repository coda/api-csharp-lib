...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class DateColumnFormat : SimpleColumnFormat,  IEquatable<DateColumnFormat>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DateColumnFormat" /> class.
        /// </summary>
        /// <param name="format">A format string using Moment syntax: https://momentjs.com/docs/#/displaying/.</param>
        public DateColumnFormat(string format = default(string), ColumnFormatType type = default(ColumnFormatType), bool? isArray = default(bool?)) : base(type, isArray)
        {
            this.Format = format;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DateColumnFormat {\n");
        ...
        {
            return this.Equals(input as DateColumnFormat);
        }

        /// <summary>
        /// Returns true if DateColumnFormat instances are equal
        /// </summary>
        /// <param name="input">Instance of DateColumnFormat to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DateColumnFormat input)
        {
            if (input == null)
                return false;
