...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class DateTimeColumnFormat : SimpleColumnFormat,  IEquatable<DateTimeColumnFormat>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DateTimeColumnFormat" /> class.
        /// </summary>
        /// <param name="dateFormat">A format string using Moment syntax: https://momentjs.com/docs/#/displaying/.</param>
        /// <param name="timeFormat">A format string using Moment syntax: https://momentjs.com/docs/#/displaying/.</param>
        public DateTimeColumnFormat(string dateFormat = default(string), string timeFormat = default(string), ColumnFormatType type = default(ColumnFormatType), bool? isArray = default(bool?)) : base(type, isArray)
        {
        ...
        /// </summary>
        /// <value>A format string using Moment syntax: https://momentjs.com/docs/#/displaying/</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DateTimeColumnFormat {\n");
        ...
        {
            return this.Equals(input as DateTimeColumnFormat);
        }

        /// <summary>
        /// Returns true if DateTimeColumnFormat instances are equal
        /// </summary>
        /// <param name="input">Instance of DateTimeColumnFormat to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DateTimeColumnFormat input)
        {
            if (input == null)
                return false;
