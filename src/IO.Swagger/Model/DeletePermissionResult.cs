...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class DeletePermissionResult :  IEquatable<DeletePermissionResult>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DeletePermissionResult" /> class.
        /// </summary>
        public DeletePermissionResult()
        {
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DeletePermissionResult {\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as DeletePermissionResult);
        }

        /// <summary>
        /// Returns true if DeletePermissionResult instances are equal
        /// </summary>
        /// <param name="input">Instance of DeletePermissionResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DeletePermissionResult input)
        {
            if (input == null)
                return false;
