...
namespace IO.Swagger.Model
{
        ...
        public partial class Doc :  IEquatable<Doc>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="id">ID of the Coda doc. (required).</param>
        /// <param name="type">The type of this resource. (required).</param>
        /// <param name="href">API link to the Coda doc. (required).</param>
        /// <param name="browserLink">Browser-friendly link to the Coda doc. (required).</param>
        /// <param name="icon">icon.</param>
        /// <param name="name">Name of the doc. (required).</param>
        /// <param name="owner">Email address of the doc owner. (required).</param>
        /// <param name="ownerName">Name of the doc owner. (required).</param>
        /// <param name="docSize">docSize.</param>
        /// <param name="sourceDoc">sourceDoc.</param>
        /// <param name="createdAt">Timestamp for when the doc was created. (required).</param>
        /// <param name="updatedAt">Timestamp for when the doc was last modified. (required).</param>
        /// <param name="published">published.</param>
        public Doc(string id = default(string), TypeEnum type = default(TypeEnum), string href = default(string), string browserLink = default(string), Icon icon = default(Icon), string name = default(string), string owner = default(string), string ownerName = default(string), DocSize docSize = default(DocSize), AllOfDocSourceDoc sourceDoc = default(AllOfDocSourceDoc), DateTime? createdAt = default(DateTime?), DateTime? updatedAt = default(DateTime?), DocPublished published = default(DocPublished))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new InvalidDataException("id is a required property for Doc and cannot be null");
            }
            else
            {
                this.Id = id;
            ...
            if (href == null)
            {
                throw new InvalidDataException("href is a required property for Doc and cannot be null");
            }
            else
            {
                this.Href = href;
            ...
            if (browserLink == null)
            {
                throw new InvalidDataException("browserLink is a required property for Doc and cannot be null");
            }
            else
            {
            ...
            if (owner == null)
            {
                throw new InvalidDataException("owner is a required property for Doc and cannot be null");
            }
            else
            {
                this.Owner = owner;
            ...
            if (ownerName == null)
            {
                throw new InvalidDataException("ownerName is a required property for Doc and cannot be null");
            }
            else
            {
            ...
            if (createdAt == null)
            {
                throw new InvalidDataException("createdAt is a required property for Doc and cannot be null");
            }
            else
            {
            ...
            if (updatedAt == null)
            {
                throw new InvalidDataException("updatedAt is a required property for Doc and cannot be null");
            }
            else
            {
        ...
        /// ID of the Coda doc.
        /// </summary>
        /// <value>ID of the Coda doc.</value>
        ...
        /// </summary>
        /// <value>API link to the Coda doc.</value>
        ...
        /// </summary>
        /// <value>Browser-friendly link to the Coda doc.</value>
        ...
        /// </summary>
        /// <value>Email address of the doc owner.</value>
        ...
        /// </summary>
        /// <value>Name of the doc owner.</value>
        [DataMember(Name="ownerName", EmitDefaultValue=false)]
        public string OwnerName { get; set; }

        /// <summary>
        /// Gets or Sets DocSize
        /// </summary>
        [DataMember(Name="docSize", EmitDefaultValue=false)]
        public DocSize DocSize { get; set; }

        /// <summary>
        /// Gets or Sets SourceDoc
        /// </summary>
        [DataMember(Name="sourceDoc", EmitDefaultValue=false)]
        public AllOfDocSourceDoc SourceDoc { get; set; }

        /// <summary>
        /// Timestamp for when the doc was created.
        /// </summary>
        /// <value>Timestamp for when the doc was created.</value>
        ...
        /// </summary>
        /// <value>Timestamp for when the doc was last modified.</value>
        ...
        public DocPublished Published { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  SourceDoc: ").Append(SourceDoc).Append("\n");
        ...
        public bool Equals(Doc input)
        {
            ...
            return 
                ...
                (
                    this.SourceDoc == input.SourceDoc ||
                    (this.SourceDoc != null &&
                    this.SourceDoc.Equals(input.SourceDoc))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.SourceDoc != null)
                    hashCode = hashCode * 59 + this.SourceDoc.GetHashCode();
