...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class DocCategory :  IEquatable<DocCategory>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DocCategory" /> class.
        /// </summary>
        /// <param name="name">Name of the category. (required).</param>
        public DocCategory(string name = default(string))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for DocCategory and cannot be null");
            }
            else
            {
                this.Name = name;
        ...
        {
            return this.Equals(input as DocCategory);
        }

        /// <summary>
        /// Returns true if DocCategory instances are equal
        /// </summary>
        /// <param name="input">Instance of DocCategory to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DocCategory input)
        {
            if (input == null)
                return false;
