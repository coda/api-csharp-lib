...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class DocCategoryList :  IEquatable<DocCategoryList>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DocCategoryList" /> class.
        /// </summary>
        /// <param name="items">Categories for the doc. (required).</param>
        public DocCategoryList(List<DocCategory> items = default(List<DocCategory>))
        {
            // to ensure "items" is required (not null)
            if (items == null)
            {
                throw new InvalidDataException("items is a required property for DocCategoryList and cannot be null");
            }
            else
            {
                this.Items = items;
        ...
        /// </summary>
        /// <value>Categories for the doc.</value>
        [DataMember(Name="items", EmitDefaultValue=false)]
        public List<DocCategory> Items { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DocCategoryList {\n");
        ...
        {
            return this.Equals(input as DocCategoryList);
        }

        /// <summary>
        /// Returns true if DocCategoryList instances are equal
        /// </summary>
        /// <param name="input">Instance of DocCategoryList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DocCategoryList input)
        {
            if (input == null)
                return false;
