...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class DocCreate :  IEquatable<DocCreate>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DocCreate" /> class.
        /// </summary>
        /// <param name="title">Title of the new doc. Defaults to &#x27;Untitled&#x27;..</param>
        /// <param name="sourceDoc">An optional doc ID from which to create a copy..</param>
        /// <param name="timezone">The timezone to use for the newly created doc..</param>
        /// <param name="folderId">The ID of the folder within which to create this doc. Defaults to your \&quot;My Docs\&quot; folder in the oldest workspace you joined; this is subject to change. You can get this ID by opening the folder in the docs list on your computer and grabbing the &#x60;folderId&#x60; query parameter. .</param>
        public DocCreate(string title = default(string), string sourceDoc = default(string), string timezone = default(string), string folderId = default(string))
        {
            this.Title = title;
        ...
        /// </summary>
        /// <value>Title of the new doc. Defaults to &#x27;Untitled&#x27;.</value>
        ...
        /// </summary>
        /// <value>An optional doc ID from which to create a copy.</value>
        ...
        /// </summary>
        /// <value>The timezone to use for the newly created doc.</value>
        ...
        /// </summary>
        /// <value>The ID of the folder within which to create this doc. Defaults to your \&quot;My Docs\&quot; folder in the oldest workspace you joined; this is subject to change. You can get this ID by opening the folder in the docs list on your computer and grabbing the &#x60;folderId&#x60; query parameter. </value>
        ...
        {
            return this.Equals(input as DocCreate);
        }

        /// <summary>
        /// Returns true if DocCreate instances are equal
        /// </summary>
        /// <param name="input">Instance of DocCreate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DocCreate input)
        {
            if (input == null)
                return false;
