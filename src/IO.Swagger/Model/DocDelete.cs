...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class DocDelete :  IEquatable<DocDelete>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DocDelete" /> class.
        /// </summary>
        public DocDelete()
        {
        }
        ...
        {
            return this.Equals(input as DocDelete);
        }

        /// <summary>
        /// Returns true if DocDelete instances are equal
        /// </summary>
        /// <param name="input">Instance of DocDelete to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DocDelete input)
        {
            if (input == null)
                return false;
