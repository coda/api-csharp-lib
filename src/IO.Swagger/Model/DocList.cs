...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class DocList :  IEquatable<DocList>, IValidatableObject
    {
        /// <summary>
        ...
        public DocList(List<Doc> items = default(List<Doc>), string href = default(string), NextPageToken nextPageToken = default(NextPageToken), AllOfDocListNextPageLink nextPageLink = default(AllOfDocListNextPageLink))
        {
            // to ensure "items" is required (not null)
            if (items == null)
            {
                throw new InvalidDataException("items is a required property for DocList and cannot be null");
            }
            else
            {
                this.Items = items;
        ...
        public AllOfDocListNextPageLink NextPageLink { get; set; }
        ...
        {
            return this.Equals(input as DocList);
        }

        /// <summary>
        /// Returns true if DocList instances are equal
        /// </summary>
        /// <param name="input">Instance of DocList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DocList input)
        {
            if (input == null)
                return false;
