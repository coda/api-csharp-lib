...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class DocPublish :  IEquatable<DocPublish>, IValidatableObject
    {
        /// <summary>
        /// Gets or Sets Mode
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DocPublish" /> class.
        /// </summary>
        /// <param name="slug">Slug for the published doc..</param>
        /// <param name="discoverable">If true, indicates that the doc is discoverable..</param>
        /// <param name="earnCredit">If true, new users may be required to sign in to view content within this document. You will receive Coda credit for each user who signs up via your doc. .</param>
        /// <param name="categoryNames">The names of categories to apply to the document..</param>
        /// <param name="mode">mode.</param>
        public DocPublish(string slug = default(string), bool? discoverable = default(bool?), bool? earnCredit = default(bool?), List<string> categoryNames = default(List<string>), DocPublishMode? mode = default(DocPublishMode?))
        {
            this.Slug = slug;
        ...
        /// </summary>
        /// <value>Slug for the published doc.</value>
        ...
        /// </summary>
        /// <value>The names of categories to apply to the document.</value>
        ...
        {
            return this.Equals(input as DocPublish);
        }

        /// <summary>
        /// Returns true if DocPublish instances are equal
        /// </summary>
        /// <param name="input">Instance of DocPublish to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DocPublish input)
        {
            if (input == null)
                return false;
