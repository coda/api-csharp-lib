...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class DocReference :  IEquatable<DocReference>, IValidatableObject
    {
        /// <summary>
        ...
        public DocReference(string id = default(string), TypeEnum type = default(TypeEnum), string href = default(string), string browserLink = default(string))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new InvalidDataException("id is a required property for DocReference and cannot be null");
            }
            else
            {
                this.Id = id;
            ...
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for DocReference and cannot be null");
            }
            else
            {
                this.Type = type;
            ...
            if (href == null)
            {
                throw new InvalidDataException("href is a required property for DocReference and cannot be null");
            }
            else
            {
                this.Href = href;
            ...
            if (browserLink == null)
            {
                throw new InvalidDataException("browserLink is a required property for DocReference and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as DocReference);
        }

        /// <summary>
        /// Returns true if DocReference instances are equal
        /// </summary>
        /// <param name="input">Instance of DocReference to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DocReference input)
        {
            if (input == null)
                return false;
