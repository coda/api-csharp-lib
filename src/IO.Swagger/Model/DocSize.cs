...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class DocSize :  IEquatable<DocSize>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DocSize" /> class.
        /// </summary>
        /// <param name="totalRowCount">The number of rows contained within all tables of the doc. (required).</param>
        /// <param name="tableAndViewCount">The total number of tables and views contained within the doc. (required).</param>
        /// <param name="pageCount">The total number of page contained within the doc. (required).</param>
        /// <param name="overApiSizeLimit">If true, indicates that the doc is over the API size limit. (required).</param>
        public DocSize(decimal? totalRowCount = default(decimal?), decimal? tableAndViewCount = default(decimal?), decimal? pageCount = default(decimal?), bool? overApiSizeLimit = default(bool?))
        {
            // to ensure "totalRowCount" is required (not null)
            if (totalRowCount == null)
            {
                throw new InvalidDataException("totalRowCount is a required property for DocSize and cannot be null");
            }
            else
            {
                this.TotalRowCount = totalRowCount;
            }
            // to ensure "tableAndViewCount" is required (not null)
            if (tableAndViewCount == null)
            {
                throw new InvalidDataException("tableAndViewCount is a required property for DocSize and cannot be null");
            }
            else
            {
            ...
            if (pageCount == null)
            {
                throw new InvalidDataException("pageCount is a required property for DocSize and cannot be null");
            }
            else
            {
                this.PageCount = pageCount;
            }
            // to ensure "overApiSizeLimit" is required (not null)
            if (overApiSizeLimit == null)
            {
                throw new InvalidDataException("overApiSizeLimit is a required property for DocSize and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        /// <value>The number of rows contained within all tables of the doc.</value>
        ...
        /// </summary>
        /// <value>The total number of tables and views contained within the doc.</value>
        [DataMember(Name="tableAndViewCount", EmitDefaultValue=false)]
        public decimal? TableAndViewCount { get; set; }

        /// <summary>
        /// The total number of page contained within the doc.
        /// </summary>
        /// <value>The total number of page contained within the doc.</value>
        ...
        /// </summary>
        /// <value>If true, indicates that the doc is over the API size limit.</value>
        [DataMember(Name="overApiSizeLimit", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DocSize {\n");
            sb.Append("  TotalRowCount: ").Append(TotalRowCount).Append("\n");
            sb.Append("  TableAndViewCount: ").Append(TableAndViewCount).Append("\n");
            sb.Append("  PageCount: ").Append(PageCount).Append("\n");
            sb.Append("  OverApiSizeLimit: ").Append(OverApiSizeLimit).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as DocSize);
        }

        /// <summary>
        /// Returns true if DocSize instances are equal
        /// </summary>
        /// <param name="input">Instance of DocSize to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DocSize input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.TableAndViewCount == input.TableAndViewCount ||
                    (this.TableAndViewCount != null &&
                    this.TableAndViewCount.Equals(input.TableAndViewCount))
                ) && 
                (
                ...
                (
                    this.OverApiSizeLimit == input.OverApiSizeLimit ||
                    (this.OverApiSizeLimit != null &&
                    this.OverApiSizeLimit.Equals(input.OverApiSizeLimit))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.TableAndViewCount != null)
                    hashCode = hashCode * 59 + this.TableAndViewCount.GetHashCode();
                if (this.PageCount != null)
                    hashCode = hashCode * 59 + this.PageCount.GetHashCode();
                if (this.OverApiSizeLimit != null)
                    hashCode = hashCode * 59 + this.OverApiSizeLimit.GetHashCode();
                return hashCode;
            }
        }
