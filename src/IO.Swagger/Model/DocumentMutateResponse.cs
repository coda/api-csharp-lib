...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class DocumentMutateResponse :  IEquatable<DocumentMutateResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DocumentMutateResponse" /> class.
        /// </summary>
        /// <param name="requestId">An arbitrary unique identifier for this request. (required).</param>
        public DocumentMutateResponse(string requestId = default(string))
        {
            // to ensure "requestId" is required (not null)
            if (requestId == null)
            {
                throw new InvalidDataException("requestId is a required property for DocumentMutateResponse and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        /// <value>An arbitrary unique identifier for this request.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DocumentMutateResponse {\n");
        ...
        {
            return this.Equals(input as DocumentMutateResponse);
        }

        /// <summary>
        /// Returns true if DocumentMutateResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of DocumentMutateResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DocumentMutateResponse input)
        {
            if (input == null)
                return false;
