...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class DomainPrincipal :  IEquatable<DomainPrincipal>, IValidatableObject
    {
        /// <summary>
        /// Gets or Sets Type
        /// </summary>
        ...
        /// <param name="domain">Domain for the principal. (required).</param>
        public DomainPrincipal(PrincipalType type = default(PrincipalType), string domain = default(string))
        {
            // to ensure "type" is required (not null)
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for DomainPrincipal and cannot be null");
            }
            else
            {
                this.Type = type;
            ...
            if (domain == null)
            {
                throw new InvalidDataException("domain is a required property for DomainPrincipal and cannot be null");
            }
            else
            {
                this.Domain = domain;
        ...
        /// </summary>
        /// <value>Domain for the principal.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DomainPrincipal {\n");
        ...
        {
            return this.Equals(input as DomainPrincipal);
        }

        /// <summary>
        /// Returns true if DomainPrincipal instances are equal
        /// </summary>
        /// <param name="input">Instance of DomainPrincipal to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DomainPrincipal input)
        {
            if (input == null)
                return false;
