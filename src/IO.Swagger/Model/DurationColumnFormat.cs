...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class DurationColumnFormat : SimpleColumnFormat,  IEquatable<DurationColumnFormat>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DurationColumnFormat" /> class.
        /// </summary>
        /// <param name="precision">precision.</param>
        /// <param name="maxUnit">maxUnit.</param>
        public DurationColumnFormat(int? precision = default(int?),  maxUnit = default(), ColumnFormatType type = default(ColumnFormatType), bool? isArray = default(bool?)) : base(type, isArray)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DurationColumnFormat {\n");
        ...
        {
            return this.Equals(input as DurationColumnFormat);
        }

        /// <summary>
        /// Returns true if DurationColumnFormat instances are equal
        /// </summary>
        /// <param name="input">Instance of DurationColumnFormat to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DurationColumnFormat input)
        {
            if (input == null)
                return false;
            ...
            return base.Equals(input) && 
                ...
                (
                    this.MaxUnit == input.MaxUnit ||
                    (this.MaxUnit != null &&
                    this.MaxUnit.Equals(input.MaxUnit))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.MaxUnit != null)
                    hashCode = hashCode * 59 + this.MaxUnit.GetHashCode();
                return hashCode;
            }
        }
