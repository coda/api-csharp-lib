...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class EmailPrincipal :  IEquatable<EmailPrincipal>, IValidatableObject
    {
        /// <summary>
        /// Gets or Sets Type
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="EmailPrincipal" /> class.
        /// </summary>
        /// <param name="type">type (required).</param>
        /// <param name="email">Email for the principal. (required).</param>
        public EmailPrincipal(PrincipalType type = default(PrincipalType), string email = default(string))
        {
            // to ensure "type" is required (not null)
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for EmailPrincipal and cannot be null");
            }
            else
            {
                this.Type = type;
            ...
            if (email == null)
            {
                throw new InvalidDataException("email is a required property for EmailPrincipal and cannot be null");
            }
            else
            {
                this.Email = email;
        ...
        /// </summary>
        /// <value>Email for the principal.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EmailPrincipal {\n");
        ...
        {
            return this.Equals(input as EmailPrincipal);
        }

        /// <summary>
        /// Returns true if EmailPrincipal instances are equal
        /// </summary>
        /// <param name="input">Instance of EmailPrincipal to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EmailPrincipal input)
        {
            if (input == null)
                return false;
