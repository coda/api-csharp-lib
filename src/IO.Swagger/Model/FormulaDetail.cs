...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class FormulaDetail :  IEquatable<FormulaDetail>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FormulaDetail" /> class.
        /// </summary>
        ...
        public FormulaDetail(bool? valid = default(bool?), bool? isVolatile = default(bool?), bool? hasUserFormula = default(bool?), bool? hasTodayFormula = default(bool?), bool? hasNowFormula = default(bool?))
        {
            // to ensure "valid" is required (not null)
            if (valid == null)
            {
                throw new InvalidDataException("valid is a required property for FormulaDetail and cannot be null");
            }
            else
            {
                this.Valid = valid;
        ...
        {
            return this.Equals(input as FormulaDetail);
        }

        /// <summary>
        /// Returns true if FormulaDetail instances are equal
        /// </summary>
        /// <param name="input">Instance of FormulaDetail to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FormulaDetail input)
        {
            if (input == null)
                return false;
