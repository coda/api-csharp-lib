...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class FormulaList :  IEquatable<FormulaList>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FormulaList" /> class.
        /// </summary>
        ...
        public FormulaList(List<FormulaReference> items = default(List<FormulaReference>), string href = default(string), NextPageToken nextPageToken = default(NextPageToken), AllOfFormulaListNextPageLink nextPageLink = default(AllOfFormulaListNextPageLink))
        {
            // to ensure "items" is required (not null)
            if (items == null)
            {
                throw new InvalidDataException("items is a required property for FormulaList and cannot be null");
            }
            else
            {
                this.Items = items;
        ...
        public List<FormulaReference> Items { get; set; }
        ...
        public AllOfFormulaListNextPageLink NextPageLink { get; set; }
        ...
        {
            return this.Equals(input as FormulaList);
        }

        /// <summary>
        /// Returns true if FormulaList instances are equal
        /// </summary>
        /// <param name="input">Instance of FormulaList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FormulaList input)
        {
            if (input == null)
                return false;
