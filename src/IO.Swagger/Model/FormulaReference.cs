...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class FormulaReference :  IEquatable<FormulaReference>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="FormulaReference" /> class.
        /// </summary>
        /// <param name="id">ID of the formula. (required).</param>
        /// <param name="type">The type of this resource. (required).</param>
        /// <param name="href">API link to the formula. (required).</param>
        /// <param name="name">Name of the formula. (required).</param>
        /// <param name="parent">parent.</param>
        public FormulaReference(string id = default(string), TypeEnum type = default(TypeEnum), string href = default(string), string name = default(string), PageReference parent = default(PageReference))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new InvalidDataException("id is a required property for FormulaReference and cannot be null");
            }
            else
            {
                this.Id = id;
            ...
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for FormulaReference and cannot be null");
            }
            else
            {
                this.Type = type;
            ...
            if (href == null)
            {
                throw new InvalidDataException("href is a required property for FormulaReference and cannot be null");
            }
            else
            {
                this.Href = href;
            ...
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for FormulaReference and cannot be null");
            }
            else
            {
                this.Name = name;
        ...
        /// </summary>
        /// <value>API link to the formula.</value>
        ...
        /// Name of the formula.
        /// </summary>
        /// <value>Name of the formula.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class FormulaReference {\n");
        ...
        {
            return this.Equals(input as FormulaReference);
        }

        /// <summary>
        /// Returns true if FormulaReference instances are equal
        /// </summary>
        /// <param name="input">Instance of FormulaReference to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FormulaReference input)
        {
            if (input == null)
                return false;
