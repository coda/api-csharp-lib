...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class Icon :  IEquatable<Icon>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Icon" /> class.
        /// </summary>
        /// <param name="name">Name of the icon. (required).</param>
        /// <param name="type">MIME type of the icon (required).</param>
        /// <param name="browserLink">Browser-friendly link to an icon. (required).</param>
        public Icon(string name = default(string), string type = default(string), string browserLink = default(string))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for Icon and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for Icon and cannot be null");
            }
            else
            {
                this.Type = type;
            ...
            if (browserLink == null)
            {
                throw new InvalidDataException("browserLink is a required property for Icon and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        /// <value>MIME type of the icon</value>
        ...
        /// </summary>
        /// <value>Browser-friendly link to an icon.</value>
