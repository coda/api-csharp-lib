...
namespace IO.Swagger.Model
{
        ...
        public partial class Image :  IEquatable<Image>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="browserLink">Browser-friendly link to an image. (required).</param>
        /// <param name="type">MIME type of the image..</param>
        /// <param name="width">The width in pixels of the image..</param>
        /// <param name="height">The height in pixels of the image..</param>
        public Image(string browserLink = default(string), string type = default(string), decimal? width = default(decimal?), decimal? height = default(decimal?))
        {
            // to ensure "browserLink" is required (not null)
            if (browserLink == null)
            {
                throw new InvalidDataException("browserLink is a required property for Image and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        /// <value>Browser-friendly link to an image.</value>
        ...
        /// </summary>
        /// <value>MIME type of the image.</value>
