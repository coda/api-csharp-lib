...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ImageUrlValue : LinkedDataObject,  IEquatable<ImageUrlValue>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ImageUrlValue" /> class.
        /// </summary>
        ...
        public ImageUrlValue(string name = default(string), string url = default(string), decimal? height = default(decimal?), decimal? width = default(decimal?), ImageStatus status = default(ImageStatus), string context = default(string), LinkedDataType type = default(LinkedDataType), string additionalType = default(string)) : base(context, type, additionalType)
        {
            this.Name = name;
            this.Url = url;
            this.Height = height;
        ...
        {
            return this.Equals(input as ImageUrlValue);
        }

        /// <summary>
        /// Returns true if ImageUrlValue instances are equal
        /// </summary>
        /// <param name="input">Instance of ImageUrlValue to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ImageUrlValue input)
        {
            if (input == null)
                return false;
