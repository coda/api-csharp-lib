...
namespace IO.Swagger.Model
{
        ...
        public partial class InlineResponse400 :  IEquatable<InlineResponse400>, IValidatableObject
    {
        ...
        public InlineResponse400(decimal? statusCode = default(decimal?), string statusMessage = default(string), string message = default(string))
        {
            ...
            {
                throw new InvalidDataException("statusMessage is a required property for InlineResponse400 and cannot be null");
            }
            else
            {
