...
namespace IO.Swagger.Model
{
        ...
        public partial class InlineResponse401 :  IEquatable<InlineResponse401>, IValidatableObject
    {
        ...
        public InlineResponse401(decimal? statusCode = default(decimal?), string statusMessage = default(string), string message = default(string))
        {
            // to ensure "statusCode" is required (not null)
            if (statusCode == null)
            {
                throw new InvalidDataException("statusCode is a required property for InlineResponse401 and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("statusMessage is a required property for InlineResponse401 and cannot be null");
            }
            else
            {
