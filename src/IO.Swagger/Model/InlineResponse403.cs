...
namespace IO.Swagger.Model
{
        ...
        public partial class InlineResponse403 :  IEquatable<InlineResponse403>, IValidatableObject
    {
        ...
        public InlineResponse403(decimal? statusCode = default(decimal?), string statusMessage = default(string), string message = default(string))
        {
            ...
            {
                throw new InvalidDataException("statusMessage is a required property for InlineResponse403 and cannot be null");
            }
            else
            {
