...
namespace IO.Swagger.Model
{
        ...
        public partial class InlineResponse404 :  IEquatable<InlineResponse404>, IValidatableObject
    {
        ...
        public InlineResponse404(decimal? statusCode = default(decimal?), string statusMessage = default(string), string message = default(string))
        {
            ...
            {
                throw new InvalidDataException("statusMessage is a required property for InlineResponse404 and cannot be null");
            }
            else
            {
