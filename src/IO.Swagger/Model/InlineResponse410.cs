...
namespace IO.Swagger.Model
{
        ...
        public partial class InlineResponse410 :  IEquatable<InlineResponse410>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="statusCode">HTTP status code of the error. (required).</param>
        /// <param name="statusMessage">HTTP status message of the error. (required).</param>
        /// <param name="message">Any additional context on the error, or the same as &#x60;statusMessage&#x60; otherwise. (required).</param>
        public InlineResponse410(decimal? statusCode = default(decimal?), string statusMessage = default(string), string message = default(string))
        {
            // to ensure "statusCode" is required (not null)
            if (statusCode == null)
            {
                throw new InvalidDataException("statusCode is a required property for InlineResponse410 and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("statusMessage is a required property for InlineResponse410 and cannot be null");
            }
            else
            {
            ...
            if (message == null)
            {
                throw new InvalidDataException("message is a required property for InlineResponse410 and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        /// <value>HTTP status message of the error.</value>
        ...
        /// </summary>
        /// <value>Any additional context on the error, or the same as &#x60;statusMessage&#x60; otherwise.</value>
