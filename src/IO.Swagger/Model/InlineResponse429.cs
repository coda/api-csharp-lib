...
namespace IO.Swagger.Model
{
        ...
        public partial class InlineResponse429 :  IEquatable<InlineResponse429>, IValidatableObject
    {
        ...
        public InlineResponse429(decimal? statusCode = default(decimal?), string statusMessage = default(string), string message = default(string))
        {
            ...
            {
                throw new InvalidDataException("statusMessage is a required property for InlineResponse429 and cannot be null");
            }
            else
            {
