...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class LinkedDataObject :  IEquatable<LinkedDataObject>, IValidatableObject
    {
        /// <summary>
        /// Gets or Sets Type
        /// </summary>
        [DataMember(Name="@type", EmitDefaultValue=false)]
        public LinkedDataType Type { get; set; }
        /// <summary>
        /// Initializes a new instance of the <see cref="LinkedDataObject" /> class.
        /// </summary>
        /// <param name="context">A url describing the schema context for this object, typically \&quot;http://schema.org/\&quot;. (required).</param>
        /// <param name="type">type (required).</param>
        /// <param name="additionalType">An identifier of additional type info specific to Coda that may not be present in a schema.org taxonomy, .</param>
        public LinkedDataObject(string context = default(string), LinkedDataType type = default(LinkedDataType), string additionalType = default(string))
        {
            // to ensure "context" is required (not null)
            if (context == null)
            {
                throw new InvalidDataException("context is a required property for LinkedDataObject and cannot be null");
            }
            else
            {
            ...
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for LinkedDataObject and cannot be null");
            }
            else
            {
                this.Type = type;
        ...
        /// </summary>
        /// <value>A url describing the schema context for this object, typically \&quot;http://schema.org/\&quot;.</value>
        ...
        /// </summary>
        /// <value>An identifier of additional type info specific to Coda that may not be present in a schema.org taxonomy, </value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class LinkedDataObject {\n");
        ...
        {
            return this.Equals(input as LinkedDataObject);
        }

        /// <summary>
        /// Returns true if LinkedDataObject instances are equal
        /// </summary>
        /// <param name="input">Instance of LinkedDataObject to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LinkedDataObject input)
        {
            if (input == null)
                return false;
