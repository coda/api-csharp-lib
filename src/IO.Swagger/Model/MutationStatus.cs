...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MutationStatus :  IEquatable<MutationStatus>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MutationStatus" /> class.
        /// </summary>
        /// <param name="completed">Returns whether the mutation has completed. (required).</param>
        public MutationStatus(bool? completed = default(bool?))
        {
            // to ensure "completed" is required (not null)
            if (completed == null)
            {
                throw new InvalidDataException("completed is a required property for MutationStatus and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        /// <value>Returns whether the mutation has completed.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MutationStatus {\n");
        ...
        {
            return this.Equals(input as MutationStatus);
        }

        /// <summary>
        /// Returns true if MutationStatus instances are equal
        /// </summary>
        /// <param name="input">Instance of MutationStatus to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MutationStatus input)
        {
            if (input == null)
                return false;
