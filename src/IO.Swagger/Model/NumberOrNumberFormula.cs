...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class NumberOrNumberFormula :  IEquatable<NumberOrNumberFormula>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NumberOrNumberFormula" /> class.
        /// </summary>
        public NumberOrNumberFormula()
        {
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class NumberOrNumberFormula {\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as NumberOrNumberFormula);
        }

        /// <summary>
        /// Returns true if NumberOrNumberFormula instances are equal
        /// </summary>
        /// <param name="input">Instance of NumberOrNumberFormula to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NumberOrNumberFormula input)
        {
            if (input == null)
                return false;
