...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class NumericColumnFormat : SimpleColumnFormat,  IEquatable<NumericColumnFormat>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NumericColumnFormat" /> class.
        /// </summary>
        /// <param name="precision">The decimal precision..</param>
        /// <param name="useThousandsSeparator">Whether to use a thousands separator (like \&quot;,\&quot;) to format the numeric value..</param>
        public NumericColumnFormat(int? precision = default(int?), bool? useThousandsSeparator = default(bool?), ColumnFormatType type = default(ColumnFormatType), bool? isArray = default(bool?)) : base(type, isArray)
        {
        ...
        /// </summary>
        /// <value>Whether to use a thousands separator (like \&quot;,\&quot;) to format the numeric value.</value>
        [DataMember(Name="useThousandsSeparator", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class NumericColumnFormat {\n");
            sb.Append("  ").Append(base.ToString().Replace("\n", "\n  ")).Append("\n");
            sb.Append("  Precision: ").Append(Precision).Append("\n");
            sb.Append("  UseThousandsSeparator: ").Append(UseThousandsSeparator).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as NumericColumnFormat);
        }

        /// <summary>
        /// Returns true if NumericColumnFormat instances are equal
        /// </summary>
        /// <param name="input">Instance of NumericColumnFormat to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NumericColumnFormat input)
        {
            if (input == null)
                return false;
            ...
            return base.Equals(input) && 
                ...
                (
                    this.UseThousandsSeparator == input.UseThousandsSeparator ||
                    (this.UseThousandsSeparator != null &&
                    this.UseThousandsSeparator.Equals(input.UseThousandsSeparator))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.UseThousandsSeparator != null)
                    hashCode = hashCode * 59 + this.UseThousandsSeparator.GetHashCode();
                return hashCode;
            }
        }
