...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class OneOfCellValue :  IEquatable<OneOfCellValue>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OneOfCellValue" /> class.
        /// </summary>
        public OneOfCellValue()
        {
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OneOfCellValue {\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as OneOfCellValue);
        }

        /// <summary>
        /// Returns true if OneOfCellValue instances are equal
        /// </summary>
        /// <param name="input">Instance of OneOfCellValue to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OneOfCellValue input)
        {
            if (input == null)
                return false;
