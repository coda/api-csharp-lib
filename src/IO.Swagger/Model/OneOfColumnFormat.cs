...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class OneOfColumnFormat :  IEquatable<OneOfColumnFormat>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OneOfColumnFormat" /> class.
        /// </summary>
        public OneOfColumnFormat()
        {
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OneOfColumnFormat {\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as OneOfColumnFormat);
        }

        /// <summary>
        /// Returns true if OneOfColumnFormat instances are equal
        /// </summary>
        /// <param name="input">Instance of OneOfColumnFormat to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OneOfColumnFormat input)
        {
            if (input == null)
                return false;
