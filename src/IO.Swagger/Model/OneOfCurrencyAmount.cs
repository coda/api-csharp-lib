...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class OneOfCurrencyAmount :  IEquatable<OneOfCurrencyAmount>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OneOfCurrencyAmount" /> class.
        /// </summary>
        public OneOfCurrencyAmount()
        {
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OneOfCurrencyAmount {\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as OneOfCurrencyAmount);
        }

        /// <summary>
        /// Returns true if OneOfCurrencyAmount instances are equal
        /// </summary>
        /// <param name="input">Instance of OneOfCurrencyAmount to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OneOfCurrencyAmount input)
        {
            if (input == null)
                return false;
