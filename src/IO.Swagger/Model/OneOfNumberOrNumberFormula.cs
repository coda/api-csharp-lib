...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class OneOfNumberOrNumberFormula :  IEquatable<OneOfNumberOrNumberFormula>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OneOfNumberOrNumberFormula" /> class.
        /// </summary>
        public OneOfNumberOrNumberFormula()
        {
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OneOfNumberOrNumberFormula {\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as OneOfNumberOrNumberFormula);
        }

        /// <summary>
        /// Returns true if OneOfNumberOrNumberFormula instances are equal
        /// </summary>
        /// <param name="input">Instance of OneOfNumberOrNumberFormula to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OneOfNumberOrNumberFormula input)
        {
            if (input == null)
                return false;
