...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class OneOfPrincipal :  IEquatable<OneOfPrincipal>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OneOfPrincipal" /> class.
        /// </summary>
        public OneOfPrincipal()
        {
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OneOfPrincipal {\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as OneOfPrincipal);
        }

        /// <summary>
        /// Returns true if OneOfPrincipal instances are equal
        /// </summary>
        /// <param name="input">Instance of OneOfPrincipal to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OneOfPrincipal input)
        {
            if (input == null)
                return false;
