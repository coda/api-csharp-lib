...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class OneOfRichSingleValue :  IEquatable<OneOfRichSingleValue>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OneOfRichSingleValue" /> class.
        /// </summary>
        public OneOfRichSingleValue()
        {
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OneOfRichSingleValue {\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as OneOfRichSingleValue);
        }

        /// <summary>
        /// Returns true if OneOfRichSingleValue instances are equal
        /// </summary>
        /// <param name="input">Instance of OneOfRichSingleValue to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OneOfRichSingleValue input)
        {
            if (input == null)
                return false;
