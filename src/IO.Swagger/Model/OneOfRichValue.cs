...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class OneOfRichValue :  IEquatable<OneOfRichValue>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OneOfRichValue" /> class.
        /// </summary>
        public OneOfRichValue()
        {
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OneOfRichValue {\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as OneOfRichValue);
        }

        /// <summary>
        /// Returns true if OneOfRichValue instances are equal
        /// </summary>
        /// <param name="input">Instance of OneOfRichValue to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OneOfRichValue input)
        {
            if (input == null)
                return false;
