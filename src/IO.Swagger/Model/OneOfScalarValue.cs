...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class OneOfScalarValue :  IEquatable<OneOfScalarValue>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OneOfScalarValue" /> class.
        /// </summary>
        public OneOfScalarValue()
        {
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OneOfScalarValue {\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as OneOfScalarValue);
        }

        /// <summary>
        /// Returns true if OneOfScalarValue instances are equal
        /// </summary>
        /// <param name="input">Instance of OneOfScalarValue to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OneOfScalarValue input)
        {
            if (input == null)
                return false;
