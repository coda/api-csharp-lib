...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class OneOfValue :  IEquatable<OneOfValue>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OneOfValue" /> class.
        /// </summary>
        public OneOfValue()
        {
        }
        ...
        {
            return this.Equals(input as OneOfValue);
        }

        /// <summary>
        /// Returns true if OneOfValue instances are equal
        /// </summary>
        /// <param name="input">Instance of OneOfValue to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OneOfValue input)
        {
            if (input == null)
                return false;
