...
namespace IO.Swagger.Model
{
        ...
        public partial class Page :  IEquatable<Page>, IValidatableObject
    {
        ...
        /// <param name="subtitle">Subtitle of the page..</param>
        /// <param name="icon">icon.</param>
        /// <param name="image">image.</param>
        /// <param name="parent">parent.</param>
        /// <param name="children">children (required).</param>
        public Page(string id = default(string), TypeEnum type = default(TypeEnum), string href = default(string), string browserLink = default(string), string name = default(string), string subtitle = default(string), Icon icon = default(Icon), Image image = default(Image), PageReference parent = default(PageReference), List<PageReference> children = default(List<PageReference>))
        {
            ...
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for Page and cannot be null");
            }
            else
            {
                this.Type = type;
            ...
            if (href == null)
            {
                throw new InvalidDataException("href is a required property for Page and cannot be null");
            }
            else
            {
                this.Href = href;
            ...
            if (browserLink == null)
            {
                throw new InvalidDataException("browserLink is a required property for Page and cannot be null");
            }
            else
            {
            ...
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for Page and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            if (children == null)
            {
                throw new InvalidDataException("children is a required property for Page and cannot be null");
            }
            else
            {
        ...
        public List<PageReference> Children { get; set; }
