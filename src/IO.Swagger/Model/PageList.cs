...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class PageList :  IEquatable<PageList>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PageList" /> class.
        /// </summary>
        ...
        public PageList(List<Page> items = default(List<Page>), string href = default(string), NextPageToken nextPageToken = default(NextPageToken), AllOfPageListNextPageLink nextPageLink = default(AllOfPageListNextPageLink))
        {
            // to ensure "items" is required (not null)
            if (items == null)
            {
                throw new InvalidDataException("items is a required property for PageList and cannot be null");
            }
            else
            {
                this.Items = items;
        ...
        public AllOfPageListNextPageLink NextPageLink { get; set; }
        ...
        {
            return this.Equals(input as PageList);
        }

        /// <summary>
        /// Returns true if PageList instances are equal
        /// </summary>
        /// <param name="input">Instance of PageList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageList input)
        {
            if (input == null)
                return false;
