...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class PageReference :  IEquatable<PageReference>, IValidatableObject
    {
        /// <summary>
        ...
        /// </summary>
        /// <param name="id">ID of the page. (required).</param>
        /// <param name="type">The type of this resource. (required).</param>
        /// <param name="href">API link to the page. (required).</param>
        /// <param name="browserLink">Browser-friendly link to the page. (required).</param>
        /// <param name="name">Name of the page. (required).</param>
        public PageReference(string id = default(string), TypeEnum type = default(TypeEnum), string href = default(string), string browserLink = default(string), string name = default(string))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new InvalidDataException("id is a required property for PageReference and cannot be null");
            }
            else
            {
                this.Id = id;
            ...
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for PageReference and cannot be null");
            }
            else
            {
                this.Type = type;
            ...
            if (href == null)
            {
                throw new InvalidDataException("href is a required property for PageReference and cannot be null");
            }
            else
            {
                this.Href = href;
            ...
            if (browserLink == null)
            {
                throw new InvalidDataException("browserLink is a required property for PageReference and cannot be null");
            }
            else
            {
            ...
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for PageReference and cannot be null");
            }
            else
            {
                this.Name = name;
        ...
        /// </summary>
        /// <value>API link to the page.</value>
        ...
        /// </summary>
        /// <value>Browser-friendly link to the page.</value>
        ...
        {
            return this.Equals(input as PageReference);
        }

        /// <summary>
        /// Returns true if PageReference instances are equal
        /// </summary>
        /// <param name="input">Instance of PageReference to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageReference input)
        {
            if (input == null)
                return false;
