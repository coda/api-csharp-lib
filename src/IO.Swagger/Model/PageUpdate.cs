...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class PageUpdate :  IEquatable<PageUpdate>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PageUpdate" /> class.
        /// </summary>
        /// <param name="name">Name of the page..</param>
        /// <param name="subtitle">Subtitle of the page..</param>
        /// <param name="iconName">Name of the icon..</param>
        /// <param name="imageUrl">Url of the image to use..</param>
        public PageUpdate(string name = default(string), string subtitle = default(string), string iconName = default(string), string imageUrl = default(string))
        {
            this.Name = name;
        ...
        /// </summary>
        /// <value>Url of the image to use.</value>
        ...
        {
            return this.Equals(input as PageUpdate);
        }

        /// <summary>
        /// Returns true if PageUpdate instances are equal
        /// </summary>
        /// <param name="input">Instance of PageUpdate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageUpdate input)
        {
            if (input == null)
                return false;
