...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class PageUpdateResult : DocumentMutateResponse,  IEquatable<PageUpdateResult>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PageUpdateResult" /> class.
        /// </summary>
        /// <param name="id">ID of the updated page. (required).</param>
        public PageUpdateResult(string id = default(string), string requestId = default(string)) : base(requestId)
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new InvalidDataException("id is a required property for PageUpdateResult and cannot be null");
            }
            else
            {
                this.Id = id;
        ...
        /// </summary>
        /// <value>ID of the updated page.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PageUpdateResult {\n");
        ...
        {
            return this.Equals(input as PageUpdateResult);
        }

        /// <summary>
        /// Returns true if PageUpdateResult instances are equal
        /// </summary>
        /// <param name="input">Instance of PageUpdateResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageUpdateResult input)
        {
            if (input == null)
                return false;
