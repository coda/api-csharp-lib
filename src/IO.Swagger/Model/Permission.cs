...
namespace IO.Swagger.Model
{
        ...
        public partial class Permission :  IEquatable<Permission>, IValidatableObject
    {
        ...
        /// <param name="id">Id for the Permission (required).</param>
        /// <param name="access">access (required).</param>
        public Permission(Principal principal = default(Principal), string id = default(string), AccessType access = default(AccessType))
        {
            // to ensure "principal" is required (not null)
            if (principal == null)
            {
                throw new InvalidDataException("principal is a required property for Permission and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        /// <value>Id for the Permission</value>
