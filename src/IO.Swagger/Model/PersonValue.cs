...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class PersonValue : LinkedDataObject,  IEquatable<PersonValue>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PersonValue" /> class.
        /// </summary>
        /// <param name="name">The full name of the person. (required).</param>
        /// <param name="email">The email address of the person. (required).</param>
        public PersonValue(string name = default(string), string email = default(string), string context = default(string), LinkedDataType type = default(LinkedDataType), string additionalType = default(string)) : base(context, type, additionalType)
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for PersonValue and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            if (email == null)
            {
                throw new InvalidDataException("email is a required property for PersonValue and cannot be null");
            }
            else
            {
                this.Email = email;
        ...
        {
            return this.Equals(input as PersonValue);
        }

        /// <summary>
        /// Returns true if PersonValue instances are equal
        /// </summary>
        /// <param name="input">Instance of PersonValue to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PersonValue input)
        {
            if (input == null)
                return false;
