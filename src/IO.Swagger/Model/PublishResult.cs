...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class PublishResult : DocumentMutateResponse,  IEquatable<PublishResult>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PublishResult" /> class.
        /// </summary>
        public PublishResult(string requestId = default(string)) : base(requestId)
        {
        }
        ...
        {
            return this.Equals(input as PublishResult);
        }

        /// <summary>
        /// Returns true if PublishResult instances are equal
        /// </summary>
        /// <param name="input">Instance of PublishResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PublishResult input)
        {
            if (input == null)
                return false;
