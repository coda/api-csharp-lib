...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class PushButtonResult : DocumentMutateResponse,  IEquatable<PushButtonResult>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PushButtonResult" /> class.
        /// </summary>
        /// <param name="rowId">ID of the row where the button exists. (required).</param>
        /// <param name="columnId">ID of the column where the button exists. (required).</param>
        public PushButtonResult(string rowId = default(string), string columnId = default(string), string requestId = default(string)) : base(requestId)
        {
            // to ensure "rowId" is required (not null)
            if (rowId == null)
            {
                throw new InvalidDataException("rowId is a required property for PushButtonResult and cannot be null");
            }
            else
            {
                this.RowId = rowId;
            ...
            if (columnId == null)
            {
                throw new InvalidDataException("columnId is a required property for PushButtonResult and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        /// <value>ID of the row where the button exists.</value>
        ...
        /// </summary>
        /// <value>ID of the column where the button exists.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PushButtonResult {\n");
        ...
        {
            return this.Equals(input as PushButtonResult);
        }

        /// <summary>
        /// Returns true if PushButtonResult instances are equal
        /// </summary>
        /// <param name="input">Instance of PushButtonResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PushButtonResult input)
        {
            if (input == null)
                return false;
