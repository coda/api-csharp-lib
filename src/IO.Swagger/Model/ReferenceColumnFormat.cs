...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ReferenceColumnFormat : SimpleColumnFormat,  IEquatable<ReferenceColumnFormat>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ReferenceColumnFormat" /> class.
        /// </summary>
        /// <param name="table">table (required).</param>
        public ReferenceColumnFormat( table = default(), ColumnFormatType type = default(ColumnFormatType), bool? isArray = default(bool?)) : base(type, isArray)
        {
            // to ensure "table" is required (not null)
            if (table == null)
            {
                throw new InvalidDataException("table is a required property for ReferenceColumnFormat and cannot be null");
            }
            else
            {
                this.Table = table;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ReferenceColumnFormat {\n");
        ...
        {
            return this.Equals(input as ReferenceColumnFormat);
        }

        /// <summary>
        /// Returns true if ReferenceColumnFormat instances are equal
        /// </summary>
        /// <param name="input">Instance of ReferenceColumnFormat to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ReferenceColumnFormat input)
        {
            if (input == null)
                return false;
