...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class RichSingleValue :  IEquatable<RichSingleValue>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RichSingleValue" /> class.
        /// </summary>
        public RichSingleValue()
        {
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RichSingleValue {\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as RichSingleValue);
        }

        /// <summary>
        /// Returns true if RichSingleValue instances are equal
        /// </summary>
        /// <param name="input">Instance of RichSingleValue to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RichSingleValue input)
        {
            if (input == null)
                return false;
