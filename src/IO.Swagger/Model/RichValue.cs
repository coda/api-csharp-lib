...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class RichValue :  IEquatable<RichValue>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as RichValue);
        }

        /// <summary>
        /// Returns true if RichValue instances are equal
        /// </summary>
        /// <param name="input">Instance of RichValue to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RichValue input)
        {
            if (input == null)
                return false;
