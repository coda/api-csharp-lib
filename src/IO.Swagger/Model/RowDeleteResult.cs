...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class RowDeleteResult : DocumentMutateResponse,  IEquatable<RowDeleteResult>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RowDeleteResult" /> class.
        /// </summary>
        /// <param name="id">ID of the row to be deleted. (required).</param>
        public RowDeleteResult(string id = default(string), string requestId = default(string)) : base(requestId)
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new InvalidDataException("id is a required property for RowDeleteResult and cannot be null");
            }
            else
            {
                this.Id = id;
        ...
        /// </summary>
        /// <value>ID of the row to be deleted.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RowDeleteResult {\n");
        ...
        {
            return this.Equals(input as RowDeleteResult);
        }

        /// <summary>
        /// Returns true if RowDeleteResult instances are equal
        /// </summary>
        /// <param name="input">Instance of RowDeleteResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RowDeleteResult input)
        {
            if (input == null)
                return false;
