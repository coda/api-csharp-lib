...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class RowDetail :  IEquatable<RowDetail>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RowDetail" /> class.
        /// </summary>
        /// <param name="id">ID of the row. (required).</param>
        /// <param name="type">The type of this resource. (required).</param>
        /// <param name="href">API link to the row. (required).</param>
        /// <param name="name">The display name of the row, based on its identifying column. (required).</param>
        /// <param name="index">Index of the row within the table. (required).</param>
        /// <param name="browserLink">Browser-friendly link to the row. (required).</param>
        /// <param name="createdAt">Timestamp for when the row was created. (required).</param>
        /// <param name="updatedAt">Timestamp for when the row was last modified. (required).</param>
        /// <param name="values">Values for a specific row, represented as a hash of column IDs (or names with &#x60;useColumnNames&#x60;) to values.  (required).</param>
        /// <param name="parent">parent (required).</param>
        public RowDetail(string id = default(string), TypeEnum type = default(TypeEnum), string href = default(string), string name = default(string), int? index = default(int?), string browserLink = default(string), DateTime? createdAt = default(DateTime?), DateTime? updatedAt = default(DateTime?), Dictionary<string, CellValue> values = default(Dictionary<string, CellValue>), TableReference parent = default(TableReference))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new InvalidDataException("id is a required property for RowDetail and cannot be null");
            }
            else
            {
                this.Id = id;
            ...
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for RowDetail and cannot be null");
            }
            else
            {
                this.Type = type;
            ...
            if (href == null)
            {
                throw new InvalidDataException("href is a required property for RowDetail and cannot be null");
            }
            else
            {
                this.Href = href;
            ...
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for RowDetail and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            if (index == null)
            {
                throw new InvalidDataException("index is a required property for RowDetail and cannot be null");
            }
            else
            {
                this.Index = index;
            ...
            if (browserLink == null)
            {
                throw new InvalidDataException("browserLink is a required property for RowDetail and cannot be null");
            }
            else
            {
            ...
            if (createdAt == null)
            {
                throw new InvalidDataException("createdAt is a required property for RowDetail and cannot be null");
            }
            else
            {
            ...
            if (updatedAt == null)
            {
                throw new InvalidDataException("updatedAt is a required property for RowDetail and cannot be null");
            }
            else
            {
            ...
            if (values == null)
            {
                throw new InvalidDataException("values is a required property for RowDetail and cannot be null");
            }
            else
            {
                this.Values = values;
            ...
            if (parent == null)
            {
                throw new InvalidDataException("parent is a required property for RowDetail and cannot be null");
            }
            else
            {
                this.Parent = parent;
        ...
        /// API link to the row.
        /// </summary>
        /// <value>API link to the row.</value>
        ...
        /// </summary>
        /// <value>The display name of the row, based on its identifying column.</value>
        ...
        /// </summary>
        /// <value>Index of the row within the table.</value>
        ...
        /// </summary>
        /// <value>Browser-friendly link to the row.</value>
        ...
        /// </summary>
        /// <value>Timestamp for when the row was created.</value>
        ...
        /// </summary>
        /// <value>Timestamp for when the row was last modified.</value>
        ...
        /// </summary>
        /// <value>Values for a specific row, represented as a hash of column IDs (or names with &#x60;useColumnNames&#x60;) to values. </value>
        [DataMember(Name="values", EmitDefaultValue=false)]
        public Dictionary<string, CellValue> Values { get; set; }
        ...
        {
            return this.Equals(input as RowDetail);
        }

        /// <summary>
        /// Returns true if RowDetail instances are equal
        /// </summary>
        /// <param name="input">Instance of RowDetail to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RowDetail input)
        {
            if (input == null)
                return false;
