...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class RowEdit :  IEquatable<RowEdit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RowEdit" /> class.
        /// </summary>
        /// <param name="cells">cells (required).</param>
        public RowEdit(List<CellEdit> cells = default(List<CellEdit>))
        {
            // to ensure "cells" is required (not null)
            if (cells == null)
            {
                throw new InvalidDataException("cells is a required property for RowEdit and cannot be null");
            }
            else
            {
                this.Cells = cells;
        ...
        {
            return this.Equals(input as RowEdit);
        }

        /// <summary>
        /// Returns true if RowEdit instances are equal
        /// </summary>
        /// <param name="input">Instance of RowEdit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RowEdit input)
        {
            if (input == null)
                return false;
