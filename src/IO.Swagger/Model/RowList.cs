...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class RowList :  IEquatable<RowList>, IValidatableObject
    {
        /// <summary>
        ...
        public RowList(List<Row> items = default(List<Row>), string href = default(string), NextPageToken nextPageToken = default(NextPageToken), AllOfRowListNextPageLink nextPageLink = default(AllOfRowListNextPageLink))
        {
            // to ensure "items" is required (not null)
            if (items == null)
            {
                throw new InvalidDataException("items is a required property for RowList and cannot be null");
            }
            else
            {
                this.Items = items;
        ...
        public AllOfRowListNextPageLink NextPageLink { get; set; }
        ...
        {
            return this.Equals(input as RowList);
        }

        /// <summary>
        /// Returns true if RowList instances are equal
        /// </summary>
        /// <param name="input">Instance of RowList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RowList input)
        {
            if (input == null)
                return false;
