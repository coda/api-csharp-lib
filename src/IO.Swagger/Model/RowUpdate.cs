...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class RowUpdate :  IEquatable<RowUpdate>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RowUpdate" /> class.
        /// </summary>
        /// <param name="row">row (required).</param>
        public RowUpdate(RowEdit row = default(RowEdit))
        {
            // to ensure "row" is required (not null)
            if (row == null)
            {
                throw new InvalidDataException("row is a required property for RowUpdate and cannot be null");
            }
            else
            {
                this.Row = row;
        ...
        {
            return this.Equals(input as RowUpdate);
        }

        /// <summary>
        /// Returns true if RowUpdate instances are equal
        /// </summary>
        /// <param name="input">Instance of RowUpdate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RowUpdate input)
        {
            if (input == null)
                return false;
