...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class RowUpdateResult : DocumentMutateResponse,  IEquatable<RowUpdateResult>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RowUpdateResult" /> class.
        /// </summary>
        /// <param name="id">ID of the updated row. (required).</param>
        public RowUpdateResult(string id = default(string), string requestId = default(string)) : base(requestId)
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new InvalidDataException("id is a required property for RowUpdateResult and cannot be null");
            }
            else
            {
                this.Id = id;
        ...
        /// </summary>
        /// <value>ID of the updated row.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RowUpdateResult {\n");
        ...
        {
            return this.Equals(input as RowUpdateResult);
        }

        /// <summary>
        /// Returns true if RowUpdateResult instances are equal
        /// </summary>
        /// <param name="input">Instance of RowUpdateResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RowUpdateResult input)
        {
            if (input == null)
                return false;
