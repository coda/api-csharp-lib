...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class RowValue : LinkedDataObject,  IEquatable<RowValue>, IValidatableObject
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>The type of this resource.</value>
        [DataMember(Name="additionalType", EmitDefaultValue=false)]
        public AdditionalTypeEnum AdditionalType { get; set; }
        /// <summary>
        ...
        /// <param name="url">The url of the row. (required).</param>
        /// <param name="tableId">The ID of the table (required).</param>
        /// <param name="rowId">The ID of the table (required).</param>
        /// <param name="tableUrl">The url of the table. (required).</param>
        /// <param name="additionalType">The type of this resource. (required).</param>
        public RowValue(string name = default(string), string url = default(string), string tableId = default(string), string rowId = default(string), string tableUrl = default(string), AdditionalTypeEnum additionalType = default(AdditionalTypeEnum), string context = default(string), LinkedDataType type = default(LinkedDataType), AdditionalTypeEnum additionalType = default(AdditionalTypeEnum), string tableUrl = default(string)) : base(context, type)
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for RowValue and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            if (url == null)
            {
                throw new InvalidDataException("url is a required property for RowValue and cannot be null");
            }
            else
            {
                this.Url = url;
            ...
            if (tableId == null)
            {
                throw new InvalidDataException("tableId is a required property for RowValue and cannot be null");
            }
            else
            {
                this.TableId = tableId;
            }
            // to ensure "rowId" is required (not null)
            if (rowId == null)
            {
                throw new InvalidDataException("rowId is a required property for RowValue and cannot be null");
            }
            else
            {
                this.RowId = rowId;
            }
            // to ensure "tableUrl" is required (not null)
            if (tableUrl == null)
            {
                throw new InvalidDataException("tableUrl is a required property for RowValue and cannot be null");
            }
            else
            {
                this.TableUrl = tableUrl;
            }
            // to ensure "additionalType" is required (not null)
            if (additionalType == null)
            {
                throw new InvalidDataException("additionalType is a required property for RowValue and cannot be null");
            }
            else
            {
        ...
        /// The url of the row.
        /// </summary>
        /// <value>The url of the row.</value>
        ...
        /// </summary>
        /// <value>The url of the table.</value>
        [DataMember(Name="tableUrl", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RowValue {\n");
            sb.Append("  ").Append(base.ToString().Replace("\n", "\n  ")).Append("\n");
            sb.Append("  Name: ").Append(Name).Append("\n");
            sb.Append("  Url: ").Append(Url).Append("\n");
            sb.Append("  TableId: ").Append(TableId).Append("\n");
            sb.Append("  RowId: ").Append(RowId).Append("\n");
            sb.Append("  TableUrl: ").Append(TableUrl).Append("\n");
        ...
        {
            return this.Equals(input as RowValue);
        }

        /// <summary>
        /// Returns true if RowValue instances are equal
        /// </summary>
        /// <param name="input">Instance of RowValue to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RowValue input)
        {
            if (input == null)
                return false;
            ...
            return base.Equals(input) && 
                ...
                (
                    this.TableUrl == input.TableUrl ||
                    (this.TableUrl != null &&
                    this.TableUrl.Equals(input.TableUrl))
                ) && base.Equals(input) && 
                (
                    this.AdditionalType == input.AdditionalType ||
                    (this.AdditionalType != null &&
                    this.AdditionalType.Equals(input.AdditionalType))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.TableUrl != null)
                    hashCode = hashCode * 59 + this.TableUrl.GetHashCode();
                if (this.AdditionalType != null)
                    hashCode = hashCode * 59 + this.AdditionalType.GetHashCode();
                return hashCode;
            }
        }
