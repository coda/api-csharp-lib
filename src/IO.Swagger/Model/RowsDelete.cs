...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class RowsDelete :  IEquatable<RowsDelete>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RowsDelete" /> class.
        /// </summary>
        /// <param name="rowIds">Row IDs to delete.  (required).</param>
        public RowsDelete(List<string> rowIds = default(List<string>))
        {
            // to ensure "rowIds" is required (not null)
            if (rowIds == null)
            {
                throw new InvalidDataException("rowIds is a required property for RowsDelete and cannot be null");
            }
            else
            {
                this.RowIds = rowIds;
        ...
        {
            return this.Equals(input as RowsDelete);
        }

        /// <summary>
        /// Returns true if RowsDelete instances are equal
        /// </summary>
        /// <param name="input">Instance of RowsDelete to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RowsDelete input)
        {
            if (input == null)
                return false;
