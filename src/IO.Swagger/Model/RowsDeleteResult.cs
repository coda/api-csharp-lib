...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class RowsDeleteResult : DocumentMutateResponse,  IEquatable<RowsDeleteResult>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RowsDeleteResult" /> class.
        /// </summary>
        /// <param name="rowIds">Row IDs to delete. (required).</param>
        public RowsDeleteResult(List<string> rowIds = default(List<string>), string requestId = default(string)) : base(requestId)
        {
            // to ensure "rowIds" is required (not null)
            if (rowIds == null)
            {
                throw new InvalidDataException("rowIds is a required property for RowsDeleteResult and cannot be null");
            }
            else
            {
                this.RowIds = rowIds;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RowsDeleteResult {\n");
        ...
        {
            return this.Equals(input as RowsDeleteResult);
        }

        /// <summary>
        /// Returns true if RowsDeleteResult instances are equal
        /// </summary>
        /// <param name="input">Instance of RowsDeleteResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RowsDeleteResult input)
        {
            if (input == null)
                return false;
            ...
            return base.Equals(input) && 
                (
                    ...
                    this.RowIds != null &&
                    input.RowIds != null &&
                    this.RowIds.SequenceEqual(input.RowIds)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.RowIds != null)
                    hashCode = hashCode * 59 + this.RowIds.GetHashCode();
                return hashCode;
            }
        }
