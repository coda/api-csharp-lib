...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class RowsUpsert :  IEquatable<RowsUpsert>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RowsUpsert" /> class.
        /// </summary>
        /// <param name="rows">rows (required).</param>
        /// <param name="keyColumns">Optional column IDs, URLs, or names (fragile and discouraged), specifying columns to be used as upsert keys. .</param>
        public RowsUpsert(List<RowEdit> rows = default(List<RowEdit>), List<string> keyColumns = default(List<string>))
        {
            // to ensure "rows" is required (not null)
            if (rows == null)
            {
                throw new InvalidDataException("rows is a required property for RowsUpsert and cannot be null");
            }
            else
            {
                this.Rows = rows;
        ...
        public List<RowEdit> Rows { get; set; }

        /// <summary>
        /// Optional column IDs, URLs, or names (fragile and discouraged), specifying columns to be used as upsert keys. 
        /// </summary>
        /// <value>Optional column IDs, URLs, or names (fragile and discouraged), specifying columns to be used as upsert keys. </value>
        [DataMember(Name="keyColumns", EmitDefaultValue=false)]
        ...
        {
            return this.Equals(input as RowsUpsert);
        }

        /// <summary>
        /// Returns true if RowsUpsert instances are equal
        /// </summary>
        /// <param name="input">Instance of RowsUpsert to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RowsUpsert input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.KeyColumns == input.KeyColumns ||
                    this.KeyColumns != null &&
                    input.KeyColumns != null &&
                    this.KeyColumns.SequenceEqual(input.KeyColumns)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.KeyColumns != null)
                    hashCode = hashCode * 59 + this.KeyColumns.GetHashCode();
                return hashCode;
            }
        }
