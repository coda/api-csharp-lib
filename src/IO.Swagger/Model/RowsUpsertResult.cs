...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class RowsUpsertResult : DocumentMutateResponse,  IEquatable<RowsUpsertResult>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RowsUpsertResult" /> class.
        /// </summary>
        public RowsUpsertResult(string requestId = default(string)) : base(requestId)
        {
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RowsUpsertResult {\n");
        ...
        {
            return this.Equals(input as RowsUpsertResult);
        }

        /// <summary>
        /// Returns true if RowsUpsertResult instances are equal
        /// </summary>
        /// <param name="input">Instance of RowsUpsertResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RowsUpsertResult input)
        {
            if (input == null)
                return false;
