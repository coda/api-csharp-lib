...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ScalarValue :  IEquatable<ScalarValue>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as ScalarValue);
        }

        /// <summary>
        /// Returns true if ScalarValue instances are equal
        /// </summary>
        /// <param name="input">Instance of ScalarValue to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ScalarValue input)
        {
            if (input == null)
                return false;
