...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ScaleColumnFormat : SimpleColumnFormat,  IEquatable<ScaleColumnFormat>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ScaleColumnFormat" /> class.
        /// </summary>
        /// <param name="maximum">The maximum number allowed for this scale. (required).</param>
        /// <param name="icon">icon (required).</param>
        public ScaleColumnFormat(decimal? maximum = default(decimal?),  icon = default(), ColumnFormatType type = default(ColumnFormatType), bool? isArray = default(bool?)) : base(type, isArray)
        {
            // to ensure "maximum" is required (not null)
            if (maximum == null)
            {
                throw new InvalidDataException("maximum is a required property for ScaleColumnFormat and cannot be null");
            }
            else
            {
            ...
            if (icon == null)
            {
                throw new InvalidDataException("icon is a required property for ScaleColumnFormat and cannot be null");
            }
            else
            {
                this.Icon = icon;
        ...
        /// </summary>
        /// <value>The maximum number allowed for this scale.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ScaleColumnFormat {\n");
        ...
        {
            return this.Equals(input as ScaleColumnFormat);
        }

        /// <summary>
        /// Returns true if ScaleColumnFormat instances are equal
        /// </summary>
        /// <param name="input">Instance of ScaleColumnFormat to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ScaleColumnFormat input)
        {
            if (input == null)
                return false;
