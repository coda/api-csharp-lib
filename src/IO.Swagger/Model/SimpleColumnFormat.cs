...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class SimpleColumnFormat :  IEquatable<SimpleColumnFormat>, IValidatableObject
    {
        /// <summary>
        /// Gets or Sets Type
        /// </summary>
        [DataMember(Name="type", EmitDefaultValue=false)]
        public ColumnFormatType Type { get; set; }
        /// <summary>
        /// Initializes a new instance of the <see cref="SimpleColumnFormat" /> class.
        /// </summary>
        /// <param name="type">type (required).</param>
        /// <param name="isArray">Whether or not this column is an array. (required).</param>
        public SimpleColumnFormat(ColumnFormatType type = default(ColumnFormatType), bool? isArray = default(bool?))
        {
            // to ensure "type" is required (not null)
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for SimpleColumnFormat and cannot be null");
            }
            else
            {
                this.Type = type;
            }
            // to ensure "isArray" is required (not null)
            if (isArray == null)
            {
                throw new InvalidDataException("isArray is a required property for SimpleColumnFormat and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        /// <value>Whether or not this column is an array.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SimpleColumnFormat {\n");
        ...
        {
            return this.Equals(input as SimpleColumnFormat);
        }

        /// <summary>
        /// Returns true if SimpleColumnFormat instances are equal
        /// </summary>
        /// <param name="input">Instance of SimpleColumnFormat to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SimpleColumnFormat input)
        {
            if (input == null)
                return false;
