...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class SliderColumnFormat : SimpleColumnFormat,  IEquatable<SliderColumnFormat>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SliderColumnFormat" /> class.
        /// </summary>
        /// <param name="minimum">minimum.</param>
        /// <param name="maximum">maximum.</param>
        /// <param name="step">step.</param>
        public SliderColumnFormat( minimum = default(),  maximum = default(),  step = default(), ColumnFormatType type = default(ColumnFormatType), bool? isArray = default(bool?)) : base(type, isArray)
        {
        ...
        public  Minimum { get; set; }

        /// <summary>
        /// Gets or Sets Maximum
        /// </summary>
        [DataMember(Name="maximum", EmitDefaultValue=false)]
        public  Maximum { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SliderColumnFormat {\n");
        ...
        {
            return this.Equals(input as SliderColumnFormat);
        }

        /// <summary>
        /// Returns true if SliderColumnFormat instances are equal
        /// </summary>
        /// <param name="input">Instance of SliderColumnFormat to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SliderColumnFormat input)
        {
            if (input == null)
                return false;
