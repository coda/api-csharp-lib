...
namespace IO.Swagger.Model
{
        ...
        public partial class Sort :  IEquatable<Sort>, IValidatableObject
    {
        ...
        public Sort(ColumnReference column = default(ColumnReference), SortDirection direction = default(SortDirection))
        {
            // to ensure "column" is required (not null)
            if (column == null)
            {
                throw new InvalidDataException("column is a required property for Sort and cannot be null");
            }
            else
            {
                this.Column = column;
            ...
            if (direction == null)
            {
                throw new InvalidDataException("direction is a required property for Sort and cannot be null");
            }
            else
            {
