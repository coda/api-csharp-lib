...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class TableList :  IEquatable<TableList>, IValidatableObject
    {
        /// <summary>
        ...
        public TableList(List<TableReference> items = default(List<TableReference>), string href = default(string), NextPageToken nextPageToken = default(NextPageToken), AllOfTableListNextPageLink nextPageLink = default(AllOfTableListNextPageLink))
        {
            // to ensure "items" is required (not null)
            if (items == null)
            {
                throw new InvalidDataException("items is a required property for TableList and cannot be null");
            }
            else
            {
                this.Items = items;
        ...
        public List<TableReference> Items { get; set; }
        ...
        public AllOfTableListNextPageLink NextPageLink { get; set; }
        ...
        {
            return this.Equals(input as TableList);
        }

        /// <summary>
        /// Returns true if TableList instances are equal
        /// </summary>
        /// <param name="input">Instance of TableList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TableList input)
        {
            if (input == null)
                return false;
