...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class TableReference :  IEquatable<TableReference>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TableReference" /> class.
        /// </summary>
        ...
        public TableReference(string id = default(string), TypeEnum type = default(TypeEnum), TableType tableType = default(TableType), string href = default(string), string browserLink = default(string), string name = default(string), PageReference parent = default(PageReference))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new InvalidDataException("id is a required property for TableReference and cannot be null");
            }
            else
            {
                this.Id = id;
            ...
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for TableReference and cannot be null");
            }
            else
            {
                this.Type = type;
            ...
            if (tableType == null)
            {
                throw new InvalidDataException("tableType is a required property for TableReference and cannot be null");
            }
            else
            {
            ...
            if (href == null)
            {
                throw new InvalidDataException("href is a required property for TableReference and cannot be null");
            }
            else
            {
                this.Href = href;
            ...
            if (browserLink == null)
            {
                throw new InvalidDataException("browserLink is a required property for TableReference and cannot be null");
            }
            else
            {
            ...
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for TableReference and cannot be null");
            }
            else
            {
                this.Name = name;
        ...
        {
            return this.Equals(input as TableReference);
        }

        /// <summary>
        /// Returns true if TableReference instances are equal
        /// </summary>
        /// <param name="input">Instance of TableReference to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TableReference input)
        {
            if (input == null)
                return false;
