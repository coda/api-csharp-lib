...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class TimeColumnFormat : SimpleColumnFormat,  IEquatable<TimeColumnFormat>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TimeColumnFormat" /> class.
        /// </summary>
        /// <param name="format">A format string using Moment syntax: https://momentjs.com/docs/#/displaying/.</param>
        public TimeColumnFormat(string format = default(string), ColumnFormatType type = default(ColumnFormatType), bool? isArray = default(bool?)) : base(type, isArray)
        {
            this.Format = format;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TimeColumnFormat {\n");
        ...
        {
            return this.Equals(input as TimeColumnFormat);
        }

        /// <summary>
        /// Returns true if TimeColumnFormat instances are equal
        /// </summary>
        /// <param name="input">Instance of TimeColumnFormat to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TimeColumnFormat input)
        {
            if (input == null)
                return false;
