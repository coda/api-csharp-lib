...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class UnpublishResult :  IEquatable<UnpublishResult>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UnpublishResult" /> class.
        /// </summary>
        public UnpublishResult()
        {
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UnpublishResult {\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as UnpublishResult);
        }

        /// <summary>
        /// Returns true if UnpublishResult instances are equal
        /// </summary>
        /// <param name="input">Instance of UnpublishResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UnpublishResult input)
        {
            if (input == null)
                return false;
