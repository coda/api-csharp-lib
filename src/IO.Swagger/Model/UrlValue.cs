...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class UrlValue : LinkedDataObject,  IEquatable<UrlValue>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UrlValue" /> class.
        /// </summary>
        /// <param name="name">The user-visible text of the hyperlink..</param>
        /// <param name="url">The url of the hyperlink. (required).</param>
        public UrlValue(string name = default(string), string url = default(string), string context = default(string), LinkedDataType type = default(LinkedDataType), string additionalType = default(string)) : base(context, type, additionalType)
        {
            // to ensure "url" is required (not null)
            if (url == null)
            {
                throw new InvalidDataException("url is a required property for UrlValue and cannot be null");
            }
            else
            {
                this.Url = url;
        ...
        /// </summary>
        /// <value>The user-visible text of the hyperlink.</value>
        ...
        /// </summary>
        /// <value>The url of the hyperlink.</value>
        ...
        {
            return this.Equals(input as UrlValue);
        }

        /// <summary>
        /// Returns true if UrlValue instances are equal
        /// </summary>
        /// <param name="input">Instance of UrlValue to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UrlValue input)
        {
            if (input == null)
                return false;
