...
namespace IO.Swagger.Model
{
        ...
        public partial class User :  IEquatable<User>, IValidatableObject
    {
        ...
        /// <param name="loginId">Email address of the user. (required).</param>
        /// <param name="type">The type of this resource. (required).</param>
        /// <param name="scoped">True if the token used to make this request has restricted/scoped access to the API. (required).</param>
        /// <param name="tokenName">Returns the name of the token used for this request. (required).</param>
        /// <param name="href">API link to the user. (required).</param>
        /// <param name="pictureLink">Browser-friendly link to the user&#x27;s avatar image..</param>
        public User(string name = default(string), string loginId = default(string), TypeEnum type = default(TypeEnum), bool? scoped = default(bool?), string tokenName = default(string), string href = default(string), string pictureLink = default(string))
        {
            ...
            if (loginId == null)
            {
                throw new InvalidDataException("loginId is a required property for User and cannot be null");
            }
            else
            {
            ...
            // to ensure "scoped" is required (not null)
            if (scoped == null)
            {
                throw new InvalidDataException("scoped is a required property for User and cannot be null");
            }
            else
            {
                this.Scoped = scoped;
            ...
            if (tokenName == null)
            {
                throw new InvalidDataException("tokenName is a required property for User and cannot be null");
            }
            else
            {
            ...
            if (href == null)
            {
                throw new InvalidDataException("href is a required property for User and cannot be null");
            }
            else
            {
                this.Href = href;
        ...
        /// </summary>
        /// <value>True if the token used to make this request has restricted/scoped access to the API.</value>
        ...
        /// </summary>
        /// <value>Returns the name of the token used for this request.</value>
        ...
        /// </summary>
        /// <value>API link to the user.</value>
        ...
        /// </summary>
        /// <value>Browser-friendly link to the user&#x27;s avatar image.</value>
        ...
        public bool Equals(User input)
        {
            ...
            return 
                ...
                (
                    this.Scoped == input.Scoped ||
                    (this.Scoped != null &&
                    this.Scoped.Equals(input.Scoped))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.Scoped != null)
                    hashCode = hashCode * 59 + this.Scoped.GetHashCode();
